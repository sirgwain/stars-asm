...
L_005f:
    dx = DxReportColHdr(vprptCur->irpt, i, 0x57a4, hdc);
...
L_0097:
    ...
    StickyDlgPos(hwnd, (vprptCur + 0x10), 0x1);
...
L_019b:
    ...
    cRow = ((uint32_t)((rc.bottom + 0xffdc)) / (dyArial8 + 0x4));
...
L_02b5:
    ...
    SetWindowPos(vprptCur->hwndVScroll, 0x0, (rc.right - dx), (dyArial8 + 0x6), dx, (LOWORD(((dyArial8 + 0x4) * vprptCur->cRowsVis)) + 0x1), swp);
    SetHScrollBar();
    if ((msg != 0x1))
        goto L_030b;
    else
...
L_03b2:
    iRow = ((uint32_t)(((pt.y + 0xfffe) - (dyArial8 + 0x4))) / (dyArial8 + 0x4));
...
L_045a:
    xCur = (xCur + (vprptCur->rgbdx[i] * 0x2));
    if ((xCur <= pt.x))
        goto L_0406;
    else
        goto L_047d;
...
L_04b1:
    /* untranslated: call ReportColumnPopup(words(pt.y, pt.x), iCol, t_merge_04b1_0001) -> callresult(void) */
    goto L_04e1;

L_04c6:
    /* untranslated: call ExecuteReportClick(words(pt.y, pt.x), vprptCur->irpt, iCol, iRow) -> callresult(void) */
...
L_04fc:
    ...
    iNew = (iNew - 0x1);
    goto L_0597;
    iNew = (iNew + (vprptCur->cRowsVis + 0xffff));
    goto L_0597;
    iNew = (iNew - (vprptCur->cRowsVis + 0xffff));
    goto L_0597;
    iNew = LOWORD(lParam);
...
L_05d7:
    ...
    ScrollWindow(hwnd, 0x0, LOWORD(((dyArial8 + 0x4) * (iCur - iNew))), &(rc), &(rc));
...
L_0860:
    StickyDlgPos(hwnd, (vprptCur + 0x10), 0x0);
...
L_08f1:
    if ((vprptCur->irpt == 0x0))
        goto L_08de;
    else
        goto L_08f9;

L_08f9:
    if ((vprptCur->irpt == 0x1))
        goto L_08ce;
    else
        goto L_0901;

L_0901:
    if ((vprptCur->irpt == 0x2))
        goto L_08d6;
    else
        goto L_0909;

L_0909:
    if ((vprptCur->irpt == 0x3))
        goto L_08e6;
    else
        goto L_0914;
...
L_09e8:
    ...
    dx = GetSystemMetrics(SM_CXVSCROLL);
    /* untranslated: xTitle = part[2:0](mpicolgrbitBU[vprptCur->rgbdx[0x0]]) */
    xRight = (((rc.right - xTitle) + 0xfffe) - dx);
    ccolSkipped = 0x0;
    ccolHidden = 0x0;
    i = (vprptCur->cFields + 0xffff);
...
L_0a9d:
    ccolSkipped = (ccolSkipped + 0x1);

L_0aa1:
    xRight = (xRight - (vprptCur->rgbdx[i] * 0x2));
    if ((xRight >= 0x0))
        goto L_0a58;
    else
        goto L_0ac2;
...
L_0ac2:
    ccolHidden = (ccolHidden + 0x1);

L_0ac9:
    vprptCur->cColScroll = 0x0;
    if ((ccolHidden != 0x0))
        goto L_0b04;
    else
        goto L_0adb;
...
L_0b5e:
    ...
    SetWindowPos(vprptCur->hwndHScroll, 0x0, xTitle, (((dyArial8 + 0x6) + LOWORD(((dyArial8 + 0x4) * vprptCur->cRowsVis))) + 0x1), ((rc.right - dx) - xTitle),
                 dy, swp);
    return;
}
...
L_0c51:
    ...
    vprptCur->rgbdx[i] = LOBYTE(((uint32_t)(dx) / 0x2));
    SetRect(&(rc), xCol, yRow, ((xCol + dx) + 0xffff), ((dyArial8 + 0x4) + yRow));
...
L_0cdb:
    TextOut(hdc, (rc.left + 0x3), (rc.top + 0x2), &(szTit), strlen(szTit));
    goto L_0d32;

L_0d08:
    CtrTextOut(hdc, (((uint32_t)((rc.right - rc.left)) / 0x2) + rc.left), (rc.top + 0x2), szTit, 0x0);
...
L_0daf:
    ...
    PatBlt(hdc, xCol, yRow, 0x1, (dyArial8 + 0x4), PATCOPY);
...
L_0e40:
    dx = (vprptCur->rgbdx[j] * 0x2);
    if ((yRow < (prc->top - (dyArial8 + 0x4))))
        goto L_0f47;
    else
        goto L_0e6e;
...
L_0e7c:
    SelectObject(hdc, hbrButtonShadow);
    PatBlt(hdc, ((xCol + dx) + 0xffff), yRow, 0x1, (dyArial8 + 0x4), PATCOPY);
    PatBlt(hdc, xCol, ((dyArial8 + 0x4) + yRow), dx, 0x1, PATCOPY);
    SetRect(&(rc), (xCol + 0x2), (yRow + 0x2), ((xCol + dx) + 0xfffd), (((dyArial8 + 0x4) + yRow) + 0xffff));
    if ((gd.fRptSafeDraw == 0x0))
        goto L_0f2b;
    else
        goto L_0f18;
...
L_113b:
    strcpy((0x57a4 + LOWORD((0x28 * i))), szT);
    psz = ((0x57a4 + LOWORD((0x28 * i))) + cchHistory);
    cch = CchGetString((i + 0x1b3), psz);
    /* untranslated: byte 0x25:[(psz + (cch + 0xffff))] = 0x0 */
    if ((gd.iCurGraph != i))
        goto L_11a5;
    else
        goto L_119e;
...
L_122f:
    /* untranslated: part[6:2](gd) = ((part[6:2](gd) & 0xfff0) | (iSel & 0xf)) */
    gd.fChgReports = 0x1;
    InvalidateRect(hwnd, 0x0, 0x1);
    goto L_13a8;
...
L_12f1:
    /* untranslated: part[4:2](gd) = ((part[4:2](gd) & 0xe7ff) | (((words((gd.fScoreVictory + 0x1), 0x0) % 0x3) & 0x3) << 0xb)) */
    InvalidateRect(hwnd, 0x0, 0x1);
    InitScoreDlg(hwnd, gd.fScoreVictory);
    if ((gd.fTutorial == 0x0))
        goto L_13a8;
...
L_140b:
    ...
    /* untranslated: vdxScoreX = ((words(loword((loword(GetTextExtent(hdc, psz, strlen(psz))) * 0x3)), 0x0) / 0x2) + ss:[bp-0x22]) */
    if ((0x4 <= game.cPlayer))
        goto L_1464;
    else
        goto L_145e;
...
L_1467:
     ...
     * 0x2) + vdxScoreX) + 0x8) */
    /* untranslated: dy = ((words(loword((loword((0xb * dyArial8)) * 0x3)), signhiword(loword((loword((0xb * dyArial8)) * 0x3)))) / 0x2) + 0x58) */
    goto L_150a;

L_149b:
    psz = PszGetCompressedString(idsUnarmedShips2);
    vdxScoreX = (LOWORD(GetTextExtent(hdc, psz, strlen(psz))) + 0x8);
    if ((0x4 <= game.cPlayer))
        goto L_14dd;
    else
        goto L_14d7;
...
L_14e0:
    dx = ((LOWORD((LOWORD((t_merge_14e0_0001 * dxDig)) * 0x5)) + vdxScoreX) + 0x8);
    /* untranslated: dy = ((words(loword((loword((0xb * dyArial8)) * 0x3)), signhiword(loword((loword((0xb * dyArial8)) * 0x3)))) / 0x2) + 0x58) */
...
L_150a:
    ...
    OffsetRect(&(rc), 0x0, ((dy + 0xfffc) - rc.bottom));
    dx = ((uint32_t)((dx - LOWORD(((rc.right - rc.left) * 0x3)))) / 0x4);
    SetWindowPos(GetDlgItem(hwnd, IDC_U16_0x00C6), 0x0, dx, rc.top, 0x0, 0x0, 0x5);
    SetWindowPos(GetDlgItem(hwnd, IDCANCEL), 0x0, ((dx * 0x2) + (rc.right - rc.left)), rc.top, 0x0, 0x0, 0x5);
    SetWindowPos(GetDlgItem(hwnd, IDC_HELP), 0x0, (LOWORD((0x3 * dx)) + ((rc.right - rc.left) * 0x2)), rc.top, 0x0, 0x0, 0x5);
    SetWindowText(hwnd, PszGetCompressedString((fVictory + 0x4ba)));
    return;
}
...
L_168e:
    yTop = 0x58;
    SetBkMode(hdc, TRANSPARENT);
    /* untranslated: call SelectObject(hdc, part[8:2](rghfontArial8)) -> callresult(HGDIOBJ) */
    xLeft = vdxScoreX;
    i = 0x0;
    goto L_16c6;
...
L_16d1:
    ...
    dxDig = LOWORD(__ftol());
    /* untranslated: branch ((part[6:2](rgplr[i]) >> 0x8) & 0x1) == 0x0 ? L_1780 : L_175a */

L_175a:
    /* untranslated: branch (part[84:2](rgplr[i]) & 0x1) == 0x0 ? L_1780 : L_1773 */
...
L_1780:
    if ((((LOWORD(vlprgScoreX[i]) >> 0xe) & 0x1) == 0x0))
        goto L_17b2;
    else
        goto L_17a5;
...
L_17bc:
    SetTextColor(hdc, cr);
    /* untranslated: call TextOut(hdc, ((xLeft - dxDig) + (words(loword((0x3 * dyArial8)), signhiword(loword((0x3 * dyArial8)))) / 0x2)), (((yTop - dxDig) -
     * (sext16to32(dyArial8) / 0x2)) + 0xfffc), psz, cch) -> callresult(int16_t) */
    /* untranslated: xLeft = (xLeft + (words(loword((0x3 * dyArial8)), signhiword(loword((0x3 * dyArial8)))) / 0x2)) */
    goto L_16c2;
...
L_181a:
    ...
    xLeft = (vdxScoreX + 0x4);
    /* untranslated: pt.x = (sext16to32(((words(loword((0x3 * dyArial8)), signhiword(loword((0x3 * dyArial8)))) / 0x2) + 0xfff4)) / 0x2) */
    /* untranslated: pt.y = ((sext16to32(((words(loword((0x3 * dyArial8)), signhiword(loword((0x3 * dyArial8)))) / 0x2) + 0xfff5)) / 0x2) -
     * (sext16to32(dyArial8) / 0x4)) */
    i = 0x0;
    goto L_18e4;
...
L_18ef:
    grbitVC = ((LOWORD(vlprgScoreX[i]) >> 0x6) & 0xff);
    j = 0x0;
    goto L_1927;
...
L_193e:
    ...
    /* untranslated: branch ((part[6:2](rgplr[i]) >> 0x8) & 0x1) == 0x0 ? L_19ba : L_19a1 */

L_19a1:
    /* untranslated: branch (part[84:2](rgplr[i]) & 0x1) != 0x0 ? L_19e4 : L_19ba */
...
L_19cc:
    if ((GetVCCheck(0x70, (t_merge_19cc_0001 + j)) != 0x0))
        goto L_1a6c;
    else
        goto L_19e4;
...
L_1aa7:
    /* untranslated: call PatBlt(hdc, xLeft, (yTop - (sext16to32(dyArial8) / 0x4)), 0x1, ((words(loword((loword((0x7 * dyArial8)) * 0x3)),
     * signhiword(loword((loword((0x7 * dyArial8)) * 0x3)))) / 0x2) + 0x1), PATCOPY) -> callresult(int16_t) */
    /* untranslated: xLeft = (xLeft + (words(loword((0x3 * dyArial8)), signhiword(loword((0x3 * dyArial8)))) / 0x2)) */
    goto L_18e0;
...
L_1ba8:
    /* untranslated: call PatBlt(hdc, (vdxScoreX + 0x4), (yTop - (sext16to32(dyArial8) / 0x4)), (words(loword((loword((dyArial8 * game.cPlayer)) * 0x3)),
...
L_1bee:
    yTop = (yTop + ((uint32_t)(dyArial8) / 0x2));

L_1bfa:
    t_1bfe = ids;
    ids = (ids + 0x1);
    cch = CchGetString(t_1bfe, 0x57a4);
    if ((iPass != 0x1))
        goto L_1c6b;
    else
        goto L_1c1a;
...
L_1e0c:
    ...
    dxDig = LOWORD(GetTextExtent(hdc, "9", 0x1));
    /* untranslated: call SelectObject(hdc, part[8:2](rghfontArial8)) -> callresult(HGDIOBJ) */
    /* untranslated: xLeft = ((sext16to32((loword((0x5 * dxDig)) - (words(loword((0x3 * dyArial8)), signhiword(loword((0x3 * dyArial8)))) / 0x2))) / 0x2) +
     * vdxScoreX) */
    i = 0x0;
    goto L_1e88;
...
L_1e93:
    ...
    dx45 = LOWORD(__ftol());
    /* untranslated: branch ((part[6:2](rgplr[i]) >> 0x8) & 0x1) == 0x0 ? L_1f42 : L_1f1c */

L_1f1c:
    /* untranslated: branch (part[84:2](rgplr[i]) & 0x1) == 0x0 ? L_1f42 : L_1f35 */
...
L_1f7e:
    SetTextColor(hdc, cr);
    /* untranslated: call TextOut(hdc, ((xLeft - dx45) + (words(loword((0x3 * dyArial8)), signhiword(loword((0x3 * dyArial8)))) / 0x2)), (((yTop - dx45) -
     * (sext16to32(dyArial8) / 0x2)) + 0xfffc), psz, cch) -> callresult(int16_t) */
...
L_2055:
    /* untranslated: call PatBlt(hdc, xLeft, (yTop - (sext16to32(dyArial8) / 0x4)), 0x1, ((words(loword((loword((0x9 * dyArial8)) * 0x3)),
     * signhiword(loword((loword((0x9 * dyArial8)) * 0x3)))) / 0x2) + 0x1), PATCOPY) -> callresult(int16_t) */
    xLeft = (xLeft + LOWORD((0x5 * dxDig)));
    goto L_2046;
...
L_20b5:
    PatBlt(hdc, (vdxScoreX + 0x4), (yTop - ((uint32_t)(dyArial8) / 0x4)), LOWORD((LOWORD((game.cPlayer * dxDig)) * 0x5)), 0x1, PATCOPY);
    t_20ef = ids;
    ids = (ids + 0x1);
    cch = CchGetString(t_20ef, 0x57a4);
    SetTextColor(hdc, 0x0);
    RightTextOut(hdc, vdxScoreX, yTop, 0x57a4, cch, 0x0);
    xLeft = ((LOWORD((0x5 * dxDig)) + vdxScoreX) + 0x2);
    lMax = 0x0;
    iPass = 0x0;
    goto L_2432;
...
L_2168:
    if ((((LOWORD(vlprgScoreX[j]) >> 0x5) & 0x1) == 0x0))
        goto L_22f8;
    else
        goto L_2192;
...
L_2192:
    ...
    goto L_22f5;
    /* untranslated: LOWORD(lVal) = part[4:2](vlprgScoreX[j].score) */
    /* untranslated: HIWORD(lVal) = part[6:2](vlprgScoreX[j].score) */
    goto L_22f5;
    LOWORD(lVal) = LOWORD(vlprgScoreX[j].score);
    HIWORD(lVal) = HIWORD(vlprgScoreX[j].score);
    goto L_22f5;
...
L_234c:
    /* untranslated: branch ((part[6:2](rgplr[j]) >> 0x8) & 0x1) == 0x0 ? L_2383 : L_236a */

L_236a:
    /* untranslated: branch (part[84:2](rgplr[j]) & 0x1) != 0x0 ? L_2419 : L_2383 */
...
L_2494:
    ...
    rcChart.bottom = (rcChart.bottom - (dyArial8 * 0x4));
    rc = rcChart;
    rc.top = ((uint32_t)(dyArial8) / 0x2);
    ...
    PatBlt(hdc, (rcChart.left + 0xffff), rcChart.bottom, (dx + 0x3), 0x1, PATCOPY);
    PatBlt(hdc, (rcChart.left + 0xfffe), (rcChart.bottom + 0x1), (dx + 0x4), 0x1, PATCOPY);
    PatBlt(hdc, rcChart.right, (rcChart.top + 0xffff), 0x1, (dy + 0x3), PATCOPY);
    PatBlt(hdc, (rcChart.right + 0x1), (rcChart.top + 0xfffe), 0x1, (dy + 0x4), PATCOPY);
    SelectObject(hdc, hbrButtonShadow);
    PatBlt(hdc, (rcChart.left + 0xfffe), (rcChart.top + 0xfffe), (dx + 0x3), 0x1, PATCOPY);
    PatBlt(hdc, (rcChart.left + 0xfffe), (rcChart.top + 0xffff), (dx + 0x2), 0x1, PATCOPY);
    PatBlt(hdc, (rcChart.left + 0xfffe), (rcChart.top + 0xfffe), 0x1, (dy + 0x3), PATCOPY);
    PatBlt(hdc, (rcChart.left + 0xffff), (rcChart.top + 0xfffe), 0x1, (dy + 0x2), PATCOPY);
    dx = (dx - 0x4);
    dy = (dy - 0x4);
...
L_287a:
    ...
    CtrTextOut(hdc, xCur, (rcChart.bottom + 0x6), szT, cch);
    if ((i <= 0x0))
        goto L_2915;
    else
        goto L_28e2;
...
L_28ef:
    PatBlt(hdc, xCur, (rcChart.top + 0xfffe), 0x1, (dy + 0x4), PATCOPY);
...
L_2b99:
    cInc = (uint32_t)(((int32_t)(((int32_t)((cScaleMax / 0xc)) / 0x1f4)) * 0x1f4));

L_2bd4:
    xCur = (rcChart.left + 0xfffa);
    cCur = cInc;
    goto L_2cb0;

L_2bef:
    yCur = (rcChart.bottom - LOWORD((int32_t)(((uint32_t)(((uint32_t)(dy)*cCur)) / cScaleMax))));
    if ((yCur < (((uint32_t)(dyArial8) / 0x2) + rcChart.top)))
        goto L_2ccd;
    else
        goto L_2c2a;
...
L_2c30:
    ...
    RightTextOut(hdc, xCur, (yCur - ((uint32_t)(dyArial8) / 0x2)), 0x57a4, cch, 0x0);
    PatBlt(hdc, (rcChart.left + 0xfffe), yCur, (dx + 0x4), 0x1, PATCOPY);
    cCur = (cCur + cInc);
...
L_2ccd:
    xCur = (rcChart.left + 0x6);
    yCur = (rcChart.top + 0x6);
    i = 0x0;
    goto L_2cef;
...
L_3058:
    /* untranslated: return words(LOWORD(lpsx->score), HIWORD(lpsx->score)) */
}
...
L_305e:
    /* untranslated: part[0:1](szT) = 0x38 */
...
L_3093:
    cch = CchGetString((iCol + 0x459), psz);
...
L_319a:
    cch = CchGetString((iCol + 0x472), psz);
    dx = LOWORD(GetTextExtent(hdc, psz, cch));
    goto L_324e;
    dx = ((dx * 0x2) + ((uint32_t)(dx) / 0x2));
    goto L_3277;
    dx = (dx * 0x2);
    goto L_3277;
    dx = ((dx * 0x2) - dxDigit);
    goto L_3277;
    dx = ((dx * 0x4) + ((uint32_t)(dx) / 0x2));
    goto L_3277;
    dx2 = LOWORD((0x5 * dxDigit));
    if ((dx2 <= dx))
        goto L_322b;
...
L_327a:
    cch = CchGetString((iCol + 0x47e), psz);
    dx = LOWORD(GetTextExtent(hdc, psz, cch));
    goto L_32da;
...
L_3300:
    cch = CchGetString((iCol + 0x48a), psz);
    dx = LOWORD(GetTextExtent(hdc, psz, cch));
    goto L_3349;
...
L_337d:
    dx = (dx + 0x5);
    return (((uint32_t)((dx + 0x1)) / 0x2) * 0x2);
}
...
L_343e:
    /* untranslated: lpsz = &part[8:0](rglpshdefSB[idPlayer][lppl->isb].hul) */
...
L_3612:
    rc = *(prc);
    dx = (((uint32_t)((rc.bottom - rc.top)) / 0x3) + 0xffff);
    rc.left = (rc.right - dx);
...
L_36d2:
    rc.top = ((prc->top + dx) + 0x1);
    rc.bottom = (rc.top + dx);
    FillRect(hdc, &(rc), hbrPurple);

L_3701:
    if ((IStargateFromLppl(lppl) == 0xffff))
        goto L_3748;
    else
        goto L_3717;

L_3717:
    rc.top = (((dx + 0x1) * 0x2) + prc->top);
    rc.bottom = (rc.top + dx);
    FillRect(hdc, &(rc), hbrGreen);

L_3748:
    goto L_3e61;
    if ((HIWORD(CalcPlanetMaxPop(lppl->id, lppl->iPlayer)) > HIWORD(lppl->rgwtMin[0x3])))
        goto L_378a;
    else
        goto L_376c;

L_376c:
    /* untranslated: branch hiword(callresult(int32_t)) < HIWORD(lppl->rgwtMin[0x3]) ? L_377a : L_3771 */

L_3771:
    /* untranslated: branch loword(callresult(int32_t)) >= LOWORD(lppl->rgwtMin[0x3]) ? L_378a : L_377a */

L_377a:
    SetTextColor(hdc, 0xff);

L_378a:
    cch = CommaFormatLong(szT, (uint32_t)((lppl->rgwtMin[0x3] * 0x64)));
...
L_3921:
    /* untranslated: part[2:1](szT) = 0x2d */
    /* untranslated: part[1:1](szT) = 0x2d */
    /* untranslated: part[0:1](szT) = 0x2d */
    cch = 0x3;
...
L_3c96:
    ...
    sel.pl = pl;
    DrawProductionItem(hdc, prc, 0x57a4, 0x0, 0x0, 0x2);
    goto L_3e61;
...
L_3d71:
    /* untranslated: branch (hiword(callresult(uint32_t)) & 0x0) != 0x0 ? L_3d99 : L_3d79 */
...
L_3d99:
    ...
    RightTextOut(hdc, (prc->left + dx), prc->top, 0x57a4, cch, 0x0);
...
L_3e64:
    ...
    goto L_44d7;
    i = lpfl->iplan;
    /* untranslated: call fstrcpy(&szT, &part[4:0](rglpbtlplan[lpfl->iplr][lpfl->iplan])) -> callresult(char *) */
    psz = szT;
    ExtTextOut(hdc, prc->left, prc->top, 0x4, prc, psz, strlen(psz), 0x0);
    goto L_4500;
...
L_3f7c:
    psz = PszGetFleetName(LOWORD(lpfl));
    ExtTextOut(hdc, prc->left, prc->top, 0x4, prc, psz, strlen(psz), 0x0);
    goto L_4500;
...
L_41d4:
    /* untranslated: branch HIWORD(lpfl->rgwtMin[0x4]) < hiword(EstFuelUse(lpfl, 0x0, ((part[6:2](lpfl->lpplord->rgord[0x1]) >> 0x4) & 0xf), 0xffffffff, 0x0)) ?
     * L_4229 : L_4215 */

L_4215:
    /* untranslated: branch HIWORD(lpfl->rgwtMin[0x4]) > hiword(callresult(int32_t)) ? L_4223 : L_421a */

L_421a:
    /* untranslated: branch LOWORD(lpfl->rgwtMin[0x4]) < loword(callresult(int32_t)) ? L_4229 : L_4223 */
...
L_422c:
    ...
    /* untranslated: call DrawMineralItem(hdc, ((dx * 0x4) + prc->left), prc->top, (fEnough neg 0x0), lpfl->rgwtMin[0x4]) -> callresult(void) */
    goto L_4500;
    i = IshdefPrimaryFromLpfl(lpfl, &(j));
    /* untranslated: branch HIWORD(lpfl):[((LOWORD(lpfl) + 0x2c) + (i * 0x2))] == 0x0 ? L_42a5 : L_4295 */
...
L_42a5:
    ...
    /* untranslated: psz = part[8:0](rgshdef[i].hul) */
    ExtTextOut(hdc, prc->left, prc->top, 0x4, prc, psz, strlen(psz), 0x0);
    psz = szT;
    cch = _wsprintf(psz, PCTD, lpfl->rgcsh[i]);
    chT = 0x2b;
    RightTextOut(hdc, ((LOWORD((0x6 * dx)) + prc->right) - LOWORD(GetTextExtent(hdc, &(chT), 0x1))), prc->top, psz, cch, 0x0);
    if ((j <= 0x1))
        goto L_43ca;
    else
        goto L_4387;
...
L_4387:
    TextOut(hdc, ((LOWORD((0x6 * dx)) + prc->right) - LOWORD(GetTextExtent(hdc, &(chT), 0x1))), prc->top, &(chT), 0x1);
...
L_4423:
    RightTextOut(hdc, (prc->right + 0xfffb), prc->top, psz, cch, 0x0);
    goto L_4500;
    DrawMineralItem(hdc, (prc->right + 0xfffe), prc->top, 0xffff, WtFromLpfl(lpfl));
    goto L_4500;
    psz = szT;
    cch = _wsprintf(psz, "%d", (lpfl->ifl + 0x1));
    RightTextOut(hdc, (prc->right + 0xfffe), prc->top, psz, cch, 0x0);
    goto L_4eb8;
...
L_45f2:
    ExtTextOut(hdc, prc->left, prc->top, 0x4, prc, psz, strlen(psz), 0x0);
    goto L_485a;
    /* untranslated: call DrawMineralItem(hdc, (prc->right + 0xfffe), prc->top, 0xffff, words(0x0, lpbd->cplr)) -> callresult(void) */
    goto L_485a;
    if ((LOWORD(CBattleUnits(lpbd, 0x5)) != 0x0))
        goto L_4681;
    else
        goto L_4679;

L_4679:
    /* untranslated: branch hiword(callresult(int32_t)) == 0x0 ? L_4688 : L_4681 */
...
L_4688:
    if ((LOWORD(CBattleUnits(lpbd, 0x6)) != 0x0))
        goto L_46aa;
    else
        goto L_46a2;

L_46a2:
    /* untranslated: branch hiword(callresult(int32_t)) == 0x0 ? L_46b1 : L_46aa */
...
BtlUnitsCom:
    DrawMineralItem(hdc, (prc->right + 0xfffe), prc->top, 0xffff, CBattleUnits(lpbd, i));
    goto L_485a;
    if ((icol != 0xb))
        goto L_476a;
    else
...
L_476d:
    ...
    DrawMineralItem(hdc, (prc->right + 0xfffe), prc->top, 0xffff, l);
    goto L_485a;
    i = 0xfd;
...
L_499d:
    ...
    i = IshdefPrimaryFromLpfl(lpfl, &(j));
    prc->right = (prc->right - LOWORD((0x6 * dx)));
    /* untranslated: lpsz = &part[8:0](rglpshdef[lpfl->iPlayer][i].hul) */
    ExtTextOut(hdc, prc->left, prc->top, 0x4, prc, lpsz, fstrlen(lpsz), 0x0);
    psz = szT;
    cch = _wsprintf(psz, PCTD, lpfl->rgcsh[i]);
    chT = 0x2b;
...
L_4d10:
    ...
    j = 0x4;
    goto LEFleetCount;
    /* untranslated: call DrawMineralItem(hdc, (prc->right + 0xfffe), prc->top, 0xffff, words(*(lpfl+0x2e), *(lpfl+0x2c))) -> callresult(void) */
    goto L_4e8f;
    psz = szT;
    cch = _wsprintf(psz, "%d", (lpfl->ifl + 0x1));
    RightTextOut(hdc, (prc->right + 0xfffe), prc->top, psz, cch, 0x0);
...
L_4fda:
    /* untranslated: branch ((ss:[bp+(i * 0x2)-0xe] >> 0xc) & 0xf) == 0x6 ? L_500e : L_4fe5 */
...
L_5131:
    /* untranslated: branch ((ss:[bp+(i * 0x2)-0xe] >> 0xc) & 0xf) == 0x6 ? L_5128 : L_513c */
...
L_522e:
    /* untranslated: branch ((ss:[bp+(i * 0x2)-0x14] >> 0xc) & 0xf) == 0x6 ? L_539c : L_5239 */
...
L_5290:
    ord = lpfl->lpplord->rgord[0x1];
    CchGetETA(hdc, lpfl, 0x57a4, 0x1, 0x1);
    if ((hdc == 0x0))
        goto L_5330;
    else
        goto L_52d9;
...
L_52d9:
    if ((HIWORD(EstFuelUse(lpfl, 0x0, ord.iWarp, 0xffffffff, 0x0)) < HIWORD(lpfl->rgwtMin[0x4])))
        goto L_5330;
    else
        goto L_5312;

L_5312:
    /* untranslated: branch hiword(callresult(int32_t)) > HIWORD(lpfl->rgwtMin[0x4]) ? L_5320 : L_5317 */

L_5317:
    /* untranslated: branch loword(callresult(int32_t)) <= LOWORD(lpfl->rgwtMin[0x4]) ? L_5330 : L_5320 */
...
L_535f:
    c = (LOWORD((0xa * c)) + ((uint16_t)(*(psz)) + 0xffd0));
    psz = (psz + 0x1);
    goto L_5343;
...
L_5431:
    /* untranslated: branch ((ss:[bp+(i * 0x2)-0x16] >> 0xc) & 0xf) == 0x6 ? L_54a6 : L_543c */
...
L_54ef:
    if ((memcmp(vrgZip[i], &(ord.tsell), 0xa) != 0x0))
        goto L_5528;
    else
        goto L_5513;

L_5513:
    /* untranslated: return part[10:0](vrgZip[i]) */
...
L_5535:
    ids = idsAction;
    iZip = 0xffff;
    /* untranslated: branch ((part[16:2](ord) >> 0xc) & 0xf) != 0x7 ? L_5644 : L_5552 */

L_5552:
    /* untranslated: branch ((part[14:2](ord) >> 0xc) & 0xf) == 0x0 ? L_558b : L_5565 */

L_5565:
    /* untranslated: branch ((part[14:2](ord) >> 0xc) & 0xf) != 0x2 ? L_5644 : L_5578 */

L_5578:
    if ((((ord.tsell >> 0xc) & 0xf) != 0x2))
        goto L_5644;
    else
        goto L_558b;

L_558b:
    opOrd = ((ord.tsell >> 0xc) & 0xf);
    goto L_5629;
...
L_55a7:
    /* untranslated: branch ((ss:[bp+(i * 0x2)-0x16] >> 0xc) & 0xf) != opOrd ? L_55d5 : L_55c2 */
...
L_56dd:
    ...
    /* untranslated: byte 0x25:[(psz + (strlen(psz) + 0xfffd))] = 0x0 */
    if ((fPercent == 0x0))
        goto L_574d;
    else
        goto L_571d;
...
L_571d:
    /* untranslated: call _wsprintf(szWork, "%s %d%%", psz, 0x25, (ss:[bp+(icr * 0x2)-0x16] & 0xfff)) -> callresult(int16_t) */
    goto L_578b;
...
L_577a:
    /* untranslated: call _wsprintf(szWork, t_merge_577a_0001, psz, 0x25, (ss:[bp+(icr * 0x2)-0x16] & 0xfff)) -> callresult(int16_t) */
...
L_57c6:
    _wsprintf(szWork, "%s  %dy", PszGetCompressedString(ids), 0x25, (ord.tsell + 0x1));
    goto L_5804;
...
L_580a:
    /* untranslated: branch part[10:2](ord) >= 0xb ? L_5847 : L_5813 */

L_5813:
    /* untranslated: call _wsprintf(szWork, "%s  %dly", PszGetCompressedString(ids), 0x25, loword(((part[10:2](ord) + 0x1) * 0x32))) -> callresult(int16_t) */
    goto L_5856;
...
L_5b5d:
    ...
    fmemcpy(&(vlprgidRep), &(rgidRep), (cRows * 0x2));
    vprptCur->fCached = 0x1;
...
L_5c92:
    /* untranslated: iRet = fstrcmp(&part[8:0](rglpshdefSB[idPlayer][lppl1->isb].hul), &part[8:0](rglpshdefSB[idPlayer][lppl2->isb].hul)) */
...
L_5e35:
    ...
    /* untranslated: iRet = strcmp(&part[6:2](szT), 0x57aa) */
    goto L_63d2;
...
L_600d:
    if (((*(lppl1 + 0x1a) & 0x0) != 0x0))
        goto L_602f;
    else
        goto L_6015;

L_6015:
    /* untranslated: ss:[bp-0x88] = 0x0 */
    /* untranslated: ss:[bp-0x86] = 0x0 */
    /* untranslated: pct1 = (double)dword ss:[bp-0x88] */
    goto L_6054;
...
L_6075:
    /* untranslated: ss:[bp-0x88] = 0x0 */
    /* untranslated: ss:[bp-0x86] = 0x0 */
    /* untranslated: pct2 = (double)dword ss:[bp-0x88] */
    goto L_60b4;
...
L_60b4:
    __aFfcompp();
    /* untranslated: branch JNC ? L_60d0 : L_60c8 */
...
L_60d0:
    __aFfcompp();
    /* untranslated: branch JBE ? L_60ec : L_60e4 */
...
L_60f1:
    goto L_63d2;
    /* untranslated: ss:[bp-0x7e] = (hiword((uint32_t)(words(*(lppl2+0x14), *(lppl2+0x16)) >> 0x14)) & 0x0) */
    /* untranslated: iRet = ((loword((uint32_t)(words(*(lppl1+0x14), *(lppl1+0x16)) >> 0x14)) & 0xfff) - (loword((uint32_t)(words(*(lppl2+0x14), *(lppl2+0x16))
     * >> 0x14)) & 0xfff)) */
    goto L_63d2;
    /* untranslated: ss:[bp-0x7e] = (hiword((uint32_t)(words(*(lppl2+0x14), *(lppl2+0x16)) >> 0x8)) & 0x0) */
...
L_641f:
    goto L_69e8;
    psz = PszGetFleetName(LOWORD(lpfl1));
    strcpy(szT, psz);
    psz = PszGetFleetName(LOWORD(lpfl2));
    iRet = strcmp(szT, psz);
    goto L_69e8;
    if ((lpfl1->idPlanet == 0xffff))
        goto L_6499;
    else
        goto L_6475;
...
L_66d3:
    iRet = strcmp(((0x3f00 + LOWORD((uint32_t)((l1 * 0x93)))) + 0x8), ((0x3f00 + LOWORD((uint32_t)((l2 * 0x93)))) + 0x8));
    if ((iRet != 0x0))
        goto L_6786;
    else
        goto L_6723;
...
L_6971:
    ...
    l2 = WtFromLpfl(lpfl2);
    goto LRetDiff;
    LOWORD(l1) = LOWORD(lpfl1);
    HIWORD(l1) = SIGNHIWORD(LOWORD(lpfl1));
    LOWORD(l2) = LOWORD(lpfl2);
    HIWORD(l2) = SIGNHIWORD(LOWORD(lpfl2));
    goto LRetDiff;
...
L_6b45:
    l1 = (int32_t)((CBattleUnits(lpbd1, 0x6) * 0x2));
...
L_6b8f:
    l2 = (int32_t)((CBattleUnits(lpbd2, 0x6) * 0x2));
...
L_6f67:
    iRet = fstrcmp(((uint8_t *)(rglpshdef[lpfl1->iPlayer]) + (LOWORD((uint32_t)((l1 * 0x93))) + 0x8)),
                   ((uint8_t *)(rglpshdef[lpfl2->iPlayer]) + (LOWORD((uint32_t)((l2 * 0x93))) + 0x8)));
    if ((iRet != 0x0))
        goto L_703c;
    else
        goto L_6fd9;
...
L_7474:
    /* untranslated: iRet = (iRet neg 0x0) */
...
L_75b0:
    strcpy(rgsz[cItems], rgsz[(cItems - 0x1)]);
    rgsz[(cItems - 0x1)][0x0] = 0x0;
    cItems = (cItems + 0x1);
    j = 0x0;
    goto L_7601;
...
L_79e0:
    /* untranslated: vprptCur->iSubsort = (words(ss:[bp-0x740], signhiword(ss:[bp-0x740])) % ((cSubsort + 0x3) + t_merge_79e0_0001)) */
    if ((vprptCur->irpt != 0x1))
        goto L_7a0a;
    else
        goto L_7a04;
...
L_7a32:
    vprptCur->iSubsort = (t_merge_7a32_0001 + 0x3);

L_7a3c:
    if ((iRet >= (cSubsort + 0x2)))
        goto L_7a52;
    else
        goto L_7a4c;
...
L_7a7e:
    fccolChange = 0x1;
    /* untranslated: vprptCur = (vprptCur & ((0x1 << icol) ~ 0x0)) */
...
L_7aa8:
    fccolChange = 0x1;
    vprptCur = (vprptCur | (0x1 << rgcol[iRet]));
...
L_83de:
    irowEFleetCur = (irowEFleetCur + 0x1);
    goto L_83eb;
...
L_8404:
    if ((irowEFleetCur >= 0x0))
        goto L_841b;
    else
        goto L_840e;

L_840e:
    irowEFleetCur = (vprptCur->cRows + 0xffff);
...
L_8468:
    /* untranslated: call FFindNearestObject(words(lpfl->pt.y, lpfl->pt.x), grobjFleet, &scan) -> callresult(int16_t) */
    scan.ifl = vlprgidMisc[irow];
    ChangeScanSel(&(scan), 0x2);
    /* untranslated: call FEnsurePointOnScreen(words(lpfl->pt.y, lpfl->pt.x), 0x1) -> callresult(int16_t) */
    irowEFleetCur = irow;
...
L_859f:
    fFileErrSilent = 0x1;
    _wsprintf(szWork, "%s.map", 0x56a2, 0x25);
    StreamOpen(0x57a4, 0x1012);
    fOpen = 0x1;
...
L_8601:
    cch = _wsprintf(szWork, "%d\t%d\t%d\t%s\r\n", (i + 0x1), rgptPlan[i].x, rgptPlan[i].y, PszGetCompressedPlanet(rgidPlan[i]), 0x25);
...
L_867d:
    ...
    _wsprintf(szWork, PszGetCompressedString(ids), 0x56a2, 0x25);
    if ((fSuccess == 0x0))
        goto L_86c1;
    else
        goto L_86ae;
...
L_878e:
    _wsprintf(&(szFile), "%s.p%d", 0x56a2, 0x25, (idPlayer + 0x1));
    goto L_87d4;

L_87b6:
    _wsprintf(&(szFile), "%s.pla", 0x56a2, 0x25);

L_87d4:
    StreamOpen(szFile, 0x1012);
    fOpen = 0x1;
    j = (gd.fPerPlayerDumps + 0x2);
    i = 0x0;
    goto L_8896;

L_880b:
    cch = CchGetString((i + 0x4dc), szForm);
    psz = szForm;
...
L_88d2:
    ...
    /* untranslated: part[0:1](szForm) = 0x9 */
...
L_893b:
    /* untranslated: call strcpy(&part[1:2](szForm), PszPlayerName(lppl->iPlayer, 0x1, 0x0, 0x0, 0x0, 0x0)) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
...
L_89b7:
    /* untranslated: call fstrcpy(&part[1:2](szForm), &part[8:0](rglpshdefSB[lppl->iPlayer][lppl->isb].hul)) -> callresult(char *) */
    cch = strlen(szForm);

L_8a03:
    RgToStream(&(szForm), cch);
    /* untranslated: call itoa((game.turn - lppl->turn), &part[1:2](szForm), 0xa) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
    /* untranslated: part[1:1](szForm) = 0x0 */
    if ((lppl->det != 0x7))
        goto L_8aa3;
    else
        goto L_8a6c;
...
L_8a6c:
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromLong((uint32_t)(lppl->rgwtMin[0x3] * 0x64), 0x0)) -> callresult(char *) */
    goto L_8b08;
...
L_8ac2:
    ...
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromLong(l, 0x0)) -> callresult(char *) */
...
L_8b40:
    i = PctPlanetDesirability(lppl, idPlayer);
    /* untranslated: call _wsprintf(&part[1:2](szForm), PCTDPCTPCT, i) -> callresult(int16_t) */
...
L_8ba6:
    FillPlanetProdLB(0x0, 0x0, lppl);
    /* untranslated: call strcpy(&part[1:2](szForm), 0x57a4) -> callresult(char *) */
...
L_8c01:
    ...
    /* untranslated: call _wsprintf(&part[1:2](szForm), "%ld\t%ld\t%d.%d%%", (loword((uint32_t)(words(*(lppl+0x14), *(lppl+0x16)) >> 0x8)) & 0xfff),
     * (hiword((uint32_t)(words(*(lppl+0x14), *(lppl+0x16)) >> 0x8)) & 0x0), (loword((uint32_t)(words(*(lppl+0x14), *(lppl+0x16)) >> 0x14)) & 0xfff),
     * (hiword((uint32_t)(words(*(lppl+0x14), *(lppl+0x16)) >> 0x14)) & 0x0), loword(__ftol()), loword(__ftol())) -> callresult(int16_t) */
    goto L_8d78;

L_8cf6:
    /* untranslated: part[2:1](szForm) = 0x9 */
    /* untranslated: part[1:1](szForm) = 0x9 */
    /* untranslated: part[3:1](szForm) = 0x0 */
    if ((gd.fPerPlayerDumps == 0x0))
        goto L_8d78;
    else
        goto L_8d1e;
...
L_8d35:
    /* untranslated: cch = _wsprintf(&part[3:2](szForm), "%d%%", (loword((lppl->uDefGuess * 0x6)) + 0x3)) */
    szForm[(cch + 0x3)] = 0x0;
...
L_8db6:
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromLong(lppl->rgwtMin[i], 0x0)) -> callresult(char *) */
...
L_8e3b:
    EstMineralsMined(lppl, rgl, 0xffffffff, 0x0);
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromLong(rgl[i], 0x0)) -> callresult(char *) */
...
L_8ed4:
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromInt(lppl->rgMinConc[i], 0x0)) -> callresult(char *) */
...
L_8f47:
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromInt(CResourcesAtPlanet(lppl, idPlayer), 0x0)) -> callresult(char *) */
    goto L_8f7c;
...
L_8fcd:
    /* untranslated: call strcpy(&part[1:2](szForm), PszCalcEnvVar(i, sext8to16(lppl->rgEnvVar[i]))) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
    i = (i + 0x1);
...
L_9035:
    /* untranslated: call strcpy(&part[1:2](szForm), PszCalcEnvVar(i, sext8to16(lppl->rgEnvVarOrig[i]))) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
    i = (i + 0x1);
...
L_9094:
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromInt(PctPlanetOptValue(lppl, idPlayer), 0x0)) -> callresult(char *) */
    /* untranslated: call strcat(&part[1:2](szForm), 0x1678) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
    goto L_9124;
...
L_9136:
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromInt(PctPlanetCapacity(lppl), 0x0)) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromInt(GetPlanetScannerRange(lppl, &i), 0x0)) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromInt(i, 0x0)) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
    if ((lppl->idFling != 0x0))
        goto L_9225;
    else
...
L_9225:
    i = (lppl->iWarpFling + 0x4);
    /* untranslated: call strcpy(&part[1:2](szForm), PszGetPlanetName((lppl->idFling + 0xffff))) -> callresult(char *) */
...
L_92d3:
    /* untranslated: call strcpy(&part[1:2](szForm), PszGetPlanetName((lppl->idRoute + 0xffff))) -> callresult(char *) */
...
L_9348:
    ...
    HIWORD(part) = ((HIWORD(part) & 0xff00) | (i & 0xff));
    FLookupPart(&(part));
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromInt(part[54:2](part[4:4](part)), 0x0)) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromInt(part[52:2](part[4:4](part)), 0x0)) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
...
L_94c5:
    ...
    /* untranslated: call _wsprintf(szWork, PszGetCompressedString(ids), szFile, ss) -> callresult(int16_t) */
    if ((fSuccess == 0x0))
        goto L_950b;
    else
        goto L_94f8;
...
L_95e0:
    _wsprintf(&(szFile), "%s.f%d", 0x56a2, 0x25, (idPlayer + 0x1));
    goto L_9626;

L_9608:
    _wsprintf(&(szFile), "%s.fle", 0x56a2, 0x25);
...
L_965d:
    cch = CchGetString((i + 0x4df), szForm);
    psz = szForm;
...
L_9748:
    ...
    /* untranslated: part[0:1](szForm) = 0x9 */
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromInt(lpfl->pt.x, 0x0)) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromInt(lpfl->pt.y, 0x0)) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
    if ((lpfl->idPlanet != 0xffff))
        goto L_9820;
    else
...
L_9820:
    psz = PszGetPlanetName(lpfl->idPlanet);
    /* untranslated: call strcpy(&part[1:2](szForm), psz) -> callresult(char *) */
    cch = (strlen(psz) + 0x1);
...
L_9880:
    /* untranslated: call strcpy(&part[1:2](szForm), PszGetDestName(lpfl, 0x0)) -> callresult(char *) */
    goto L_9955;
...
L_98eb:
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromInt(lpfl->dirFltX, 0x0)) -> callresult(char *) */
    strcat(szForm, 0x168d);
...
L_999a:
    /* untranslated: call fstrcpy(&part[1:2](szForm), &part[4:0](rglpbtlplan[lpfl->iplr][lpfl->iplan])) -> callresult(char *) */
    goto L_99e6;
...
L_9a94:
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromLong(lpfl->rgwtMin[i], 0x0)) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
    i = (i + 0x1);
...
L_9b13:
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromInt((lpfl->iPlayer + 0x1), 0x0)) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
    if ((lpfl->cord <= 0x1))
        goto L_9b8e;
    else
...
L_9b65:
    /* untranslated: call strcpy(&part[1:2](szForm), PszGetETA(0x0, lpfl, 0x0)) -> callresult(char *) */
    goto L_9b98;

L_9b8e:
    /* untranslated: part[1:1](szForm) = 0x30 */
    /* untranslated: part[2:1](szForm) = 0x0 */
...
L_9c0d:
    /* untranslated: i = ((part[6:2](lpfl->lpplord->rgord[0x1]) >> 0x4) & 0xf) */

L_9c28:
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromInt(i, 0x0)) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromLong(WtFromLpfl(lpfl), 0x0)) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromInt(PctCloakFromLpfl(lpfl), 0x0)) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
...
L_9d28:
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromInt(j, 0x0)) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromInt(i, 0x0)) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
    if ((lpfl->det != 0x7))
...
L_9db3:
    /* untranslated: call strcpy(&part[1:2](szForm), PszGetTaskName(lpfl, &i)) -> callresult(char *) */
    goto L_9dde;
...
L_9dde:
    RgToStream(&(szForm), strlen(szForm));
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromLong(CMineFromLpfl(lpfl), 0x0)) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromLong(CMineSweepFromLpfl(lpfl), 0x0)) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromLong(CLayMinesFromLpfl(lpfl, 0xffff, 0xffff), 0x0)) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
    /* untranslated: call strcpy(&part[1:2](szForm), PszFromLong(PctTerraFromLpfl(lpfl), 0x0)) -> callresult(char *) */
    RgToStream(&(szForm), strlen(szForm));
    l = 0x0;
    i = 0x0;
    goto L_9fdb;
...
L_a1d9:
    hwndEdit = GetDlgItem(hwnd, (i + 0x10c));
    SendMessage(hwndEdit, CB_SETEXTENDEDUI, 0x1, 0x0);
    SendMessage(hwndEdit, WM_SETFONT, HIWORD(rghfontArial8), 0x0);
...
L_a315:
    /* untranslated: branch sext8to16(part[1:2](szWork)) != 0x0 ? L_a339 : L_a321 */
...
L_a365:
    vrgcPrintMapPage[i] = ((uint16_t)(LOWORD(szWork)) + 0xffd0);
    i = (i + 0x1);
