...
L_585b:
    fstrcpy(szHulName, (LphuldefFromId(lpshdef->hul.ihuldef) + 0x8));
...
L_5ec2:
    fmemmove(lpord[2], lpord[1], LOWORD(((lpfl->cord - 1) * 0x12)));
...
L_8116:
    ...
    /* untranslated: call fmemmove(pb, part[0x14:4](*lppl), 0x8) -> callresult(void *) */
    pb = (pb + 0x8);
