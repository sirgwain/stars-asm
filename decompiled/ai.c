...
L_30e4:
    if ((HIWORD(lpfl->rgwtMin[3]) > HIWORD(t_merge_30e4_0003_wide)))
        goto L_310c;
    else
        goto L_30f0;
...
L_30f5:
    if ((LOWORD(lpfl->rgwtMin[3]) >= LOWORD(t_merge_30e4_0003_wide)))
        goto L_310c;
    else
        goto L_30fe;
...
L_3c51:
    ...
    t_scratch_mb4 = sel.pl.fNoResearch;
    if ((t_scratch_mb4 != lppl->fNoResearch))
        goto L_3cea;
    else
        goto L_3ce3;
