...
L_4136:
    ...
    if (((int32_t)((uint32_t)(((uint32_t)(dx) * (uint32_t)(dx)))) <= lSquare))
        goto L_4179;
    else
        goto L_411d;
...
L_70f4:
    if (((int32_t)(0x1) <= (int32_t)(((uint32_t)((lPopOld * (uint32_t)((-pctDesire)))) / 0xa))))
        goto L_7146;
    else
        goto L_713d;
