...
L_0adc:
    pct = ((uint32_t)(((*(lpth + 0x6) >> 0x2) & 0x3ff)) / 5);
...
L_0e63:
    cTechCur = 0;
    /* untranslated: cTech = ((int32_t)(words((HIWORD(wtMin) + 0xffff), (LOWORD(wtMin) + 0xec78)) / 0x4b0) + 6) */
    i = 0;
    goto L_0eba;
...
L_1584:
    ...
    lpflNew->rgwtMin[4] = LGetFleetStat(lpflNew, 0x1);
