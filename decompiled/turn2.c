...
L_0671:
    /* untranslated: LOWORD(lpprod) = ((LOWORD(lpprod) & 0xfc00) | loword((int32_t)(words(0x0, (cMax & 0x3ff)) << 0x0))) */
    /* untranslated: HIWORD(lpprod) = ((*(lpprod+0x2) & 0xffff) | hiword((int32_t)(words(0x0, (cMax & 0x3ff)) << 0x0))) */
...
L_309e:
    lpxfCur = lpxf;
    lpxfMax = (lpxf + LOWORD((0x19 * cXferFull)));
    goto L_34cb;
...
L_3117:
    /* untranslated: part[0x6:2](rgxf[0x0]) = LpplFromId(lpxfCur->id1)->iPlayer */
    goto L_3149;

L_3136:
    /* untranslated: part[0x6:2](rgxf[0x0]) = ((lpxfCur->id1 >> 0x9) & 0xf) */
...
L_3270:
    /* untranslated: call FSendPlrMsg(part[0x6:2](rgxf[0x0]), idm, idSrc, idSrc, LOWORD(l2), (loword((uint32_t)(l2 >> 0x10)) & 0xffff), i, idDst, LOWORD(l),
...
L_32f6:
    /* untranslated: call FSendPlrMsg(part[0x6:2](rgxf[0x1]), (idm + 4), idDst, idDst, LOWORD(l2), (loword((uint32_t)(l2 >> 0x10)) & 0xffff), i, idSrc, 0, 0) ->
     * callresult(int16_t) */
    goto L_34b7;

L_333f:
    /* untranslated: call FSendPlrMsg(part[0x6:2](rgxf[0x1]), idm, idDst, idDst, LOWORD(l), (loword((uint32_t)(l >> 0x10)) & 0xffff), i, idSrc, LOWORD(l2),
...
L_3406:
    ...
    /* untranslated: call FSendPlrMsg(part[0x6:2](rgxf[0x0]), idm, idSrc, idSrc, LOWORD(l), (loword((uint32_t)(l >> 0x10)) & 0xffff), i, idDst, 0, 0) ->
     * callresult(int16_t) */
    if ((i != 4))
        goto L_346a;
    else
...
L_346d:
    ...
    /* untranslated: call FSendPlrMsg(part[0x6:2](rgxf[0x1]), idm, idDst, idDst, LOWORD(l), (loword((uint32_t)(l >> 0x10)) & 0xffff), i, idSrc, 0, 0) ->
     * callresult(int16_t) */
...
void DropColonists() {
    ...
    int16_t  iTech;
    int16_t  iBonus;
    uint16_t scratch_bp_mfa;
    uint16_t scratch_bp_mf8;
    uint16_t t_merge_3ea3_0001;
    uint16_t scratch_bp_mf6;
    uint16_t scratch_bp_mfe;
...
L_34f8:
    lpcdCur = lpcd;
    lpcdMax = (lpcd + LOWORD((0xc * cColDrop)));
    goto L_442f;
...
L_37ad:
    scratch_bp_mfa = LOWORD((int32_t)(((uint32_t)((lpcdLook->cColonist * lPower)) / 0x64)));
    scratch_bp_mf8 = HIWORD((int32_t)(((uint32_t)((lpcdLook->cColonist * lPower)) / 0x64)));
    lPower = __ftol();
...
L_39bb:
    scratch_bp_mfa = 0x2710;
    scratch_bp_mf8 = 0x0;
    FSendPlrMsg(i, 1, pl.id, LOWORD(rgcCol[i]), (LOWORD((uint32_t)((rgcCol[i] >> 0x10))) & 0xffff), pl.id, LOWORD(__ftol()), (pl.iPlayer | 0x30), 0, 0);
...
L_3ea3:
    FSendPlrMsg2(iMax, (t_merge_3ea3_0001 + 0xa), pl.id, pl.id, 0);
...
L_4045:
    ...
    scratch_bp_mfe = 0x0;
    /* untranslated: LOWORD(prod) = ((LOWORD(prod) & 0xfc00) | loword((int32_t)(words(0x0, (((rgplr[iMax].zpq1.rgpq[ipq].w >> 0x6) & 0x3ff) & 0x3ff)) << 0x0)))
     */
    /* untranslated: HIWORD(prod) = ((HIWORD(prod) & 0xffff) | hiword((int32_t)(words(0x0, (((rgplr[iMax].zpq1.rgpq[ipq].w >> 0x6) & 0x3ff) & 0x3ff)) << 0x0)))
     */
...
L_414b:
    ...
    LpplFromId(pl.id);
    /* untranslated: farseg(callresult(PLANET *)):[faroff(callresult(PLANET *))+0x34] = LOWORD(pl.lpplprod) */
    /* untranslated: farseg(callresult(PLANET *)):[faroff(callresult(PLANET *))+0x36] = HIWORD(pl.lpplprod) */
    goto L_418e;
...
L_438e:
    iBonus = ((uint32_t)(LOWORD((LOWORD(pl.rgwtMin[0x3]) * iBonus))) / 10);

L_43a2:
    FSendPlrMsg(pl.iPlayer, 94, -2, pl.id, iTech, iBonus, 0, 0, 0, 0);
    LOWORD(rgplr[pl.iPlayer].rgResSpent[iTech]) = (LOWORD(rgplr[pl.iPlayer].rgResSpent[iTech]) + iBonus);
    HIWORD(rgplr[pl.iPlayer].rgResSpent[iTech]) = (HIWORD(rgplr[pl.iPlayer].rgResSpent[iTech]) + SIGNHIWORD(iBonus));
...
L_48aa:
    scratch_bp_m1e = ((*(lppl + 0x2c) - (pct << 0x4)) & 0xfff0);
    lppl->pctDp = 0x0;
    /* untranslated: part[0x2c:2](lppl) = (*(lppl+0x2c) | scratch_bp_m1e) */
...
L_4aa4:
    if ((Random(1000) >= LOWORD(lppl->rgwtMin[0x3])))
        goto L_4b5c;
    else
        goto L_4aca;
...
L_4d48:
    /* untranslated: branch sext8to16(byte ds:[(((0x59a2 + loword((192 * lpfl->iPlayer))) + 0x70) + lppl->iPlayer)]) == 0x1 ? L_4d89 : L_4d76 */
...
L_4f28:
    FSendPlrMsg(lpfl->iPlayer, (t_merge_4f28_0001 + scratch_bp_m20), (lpfl->id | 0x8000), lpfl->id, lppl->id, pctCur, pctNew, 0, 0, 0);
    if ((lpfl->iPlayer == lppl->iPlayer))
        goto L_4c67;
    else
        goto L_4f50;
...
L_518f:
    FSendPlrMsg(lppl->iPlayer, 37, lppl->id, lppl->id, LOWORD(lPopOld), (LOWORD((uint32_t)((lPopOld >> 0x10))) & 0xffff), LOWORD(lppl->rgwtMin[0x3]),
                (LOWORD((uint32_t)((lppl->rgwtMin[3] >> 0x10))) & 0xffff), 0, 0);
    goto NextPlanet;

L_51fb:
    /* untranslated: call FSendPlrMsg(lppl->iPlayer, 38, lppl->id, lppl->id, (LOWORD(lPopChg) neg 0x0), (loword((uint32_t)(words(((HIWORD(lPopChg) + 0x0) neg
     * 0x0), (LOWORD(lPopChg) neg 0x0)) >> 0x10)) & 0xffff), 0, 0, 0, 0) -> callresult(int16_t) */
...
L_53b9:
    ...
    /* untranslated: LOWORD(l) = (LOWORD(l) + ((loword((int32_t)(l >> 0x3)) neg 0x0) + callresult(int16_t))) */
    /* untranslated: HIWORD(l) = (HIWORD(l) + (((hiword((int32_t)(l >> 0x3)) + 0x0) neg 0x0) + signhiword(callresult(int16_t)))) */
    l = (int32_t)((l >> 0x2));
    if ((HIWORD(l) < 0x0))
        goto L_5435;
    else
...
L_54b3:
    ...
    __ftol();
    /* untranslated: LOWORD(l) = ((0x64 - loword(callresult(int32_t))) + 0x4) */
    /* untranslated: HIWORD(l) = ((0x0 - hiword(callresult(int32_t))) + 0x0) */
    l = (int32_t)((l / 6));
    if ((HIWORD(l) > 0x0))
        goto L_5535;
    else
...
L_562e:
    lppl = (lpPlanets + LOWORD((Random(cPlanet) * 0x38)));
    if ((lppl->iPlayer == -1))
        goto L_5685;
    else
        goto L_565c;
...
L_5727:
    rgAffect[i] = i;
    rgQuan[i] = (uint32_t)((Random(250) + 0x32));
    i = (i + 1);
...
L_5c1b:
    /* untranslated: lppl->lpplprod->iprodMac = part[0x0:1](iDst) */
    goto L_5c4e;
...
L_5f10:
    /* untranslated: branch (words(0x0, game.turn) % 0x64) != 0x47 ? L_5f2a : L_5f22 */
...
L_5f2a:
    /* untranslated: branch (words(0x0, game.turn) % 0x64) != 0x21 ? L_5f44 : L_5f3c */
...
void UpdatePlayerScores() {
    ...
    int32_t  lScore2nd;
    int32_t  lScoreMax;
    uint16_t scratch_bp_m86;
    uint16_t scratch_bp_m88;
...
L_6498:
    if ((score.cPlanet < MulDiv(cPlanet, GetVCVal(game.lid, 0, 0), 100)))
        goto L_6542;
    else
        goto L_64c2;

L_64c2:
    scratch_bp_m86 = ((vlprgScoreX[i].wWord | 0x40) & 0x3fc0);
    vlprgScoreX[i].grbitVC = 0x0;
    vlprgScoreX[i].wWord = (vlprgScoreX[i].wWord | scratch_bp_m86);
    if ((GetVCCheck(game.lid, 0) == 0))
        goto L_6542;
    else
        goto L_6537;
...
L_6542:
    /* untranslated: scratch_bp_m88 = loword((int32_t)(words(0x0, (score.rgcsh[0x2] & 0x1fff)) << ((score.rgcsh[0x2] >> 0xd) << 0x1))) */
    /* untranslated: scratch_bp_m86 = hiword((int32_t)(words(0x0, (score.rgcsh[0x2] & 0x1fff)) << ((score.rgcsh[0x2] >> 0xd) << 0x1))) */
    GetVCVal(game.lid, 6, 0);
    /* untranslated: branch scratch_bp_m86 < signhiword(callresult(int16_t)) ? L_6614 : L_6588 */

L_6588:
    /* untranslated: branch scratch_bp_m86 > signhiword(callresult(int16_t)) ? L_6594 : L_658d */

L_658d:
    /* untranslated: branch scratch_bp_m88 < callresult(int16_t) ? L_6614 : L_6594 */

L_6594:
    scratch_bp_m86 = ((vlprgScoreX[i].wWord | 0x800) & 0x3fc0);
    vlprgScoreX[i].grbitVC = 0x0;
    vlprgScoreX[i].wWord = (vlprgScoreX[i].wWord | scratch_bp_m86);
    if ((GetVCCheck(game.lid, 6) == 0))
        goto L_6614;
    else
        goto L_6609;
...
L_6614:
    GetVCVal(game.lid, 3, 0);
    /* untranslated: branch HIWORD(rglScore[i]) < signhiword(callresult(int16_t)) ? L_66c9 : L_663d */
...
L_6649:
    scratch_bp_m86 = ((vlprgScoreX[i].wWord | 0x100) & 0x3fc0);
    vlprgScoreX[i].grbitVC = 0x0;
    vlprgScoreX[i].wWord = (vlprgScoreX[i].wWord | scratch_bp_m86);
    if ((GetVCCheck(game.lid, 3) == 0))
        goto L_66c9;
    else
        goto L_66be;
...
L_66d6:
    if (((uint16_t)(rgplr[i].rgTech[j]) < GetVCVal(game.lid, 1, 0)))
        goto L_6715;
    else
        goto L_6711;
...
L_6722:
    if ((c < GetVCVal(game.lid, 2, 0)))
        goto L_67be;
    else
        goto L_673e;

L_673e:
    scratch_bp_m86 = ((vlprgScoreX[i].wWord | 0x80) & 0x3fc0);
    vlprgScoreX[i].grbitVC = 0x0;
    vlprgScoreX[i].wWord = (vlprgScoreX[i].wWord | scratch_bp_m86);
    if ((GetVCCheck(game.lid, 1) == 0))
        goto L_67be;
    else
        goto L_67b3;
...
L_67be:
    scratch_bp_m88 = LOWORD((int32_t)((score.cResources / 0x3e8)));
    scratch_bp_m86 = HIWORD((int32_t)((score.cResources / 0x3e8)));
    GetVCVal(game.lid, 5, 0);
    /* untranslated: branch scratch_bp_m86 < signhiword(callresult(int16_t)) ? L_62ac : L_67fd */

L_67fd:
    /* untranslated: branch scratch_bp_m86 > signhiword(callresult(int16_t)) ? L_6809 : L_6802 */

L_6802:
    /* untranslated: branch scratch_bp_m88 < callresult(int16_t) ? L_62ac : L_6809 */

L_6809:
    scratch_bp_m86 = ((vlprgScoreX[i].wWord | 0x400) & 0x3fc0);
    vlprgScoreX[i].grbitVC = 0x0;
    vlprgScoreX[i].wWord = (vlprgScoreX[i].wWord | scratch_bp_m86);
    if ((GetVCCheck(game.lid, 5) == 0))
        goto L_62ac;
    else
        goto L_687e;
...
L_6a06:
    if ((game.turn < GetVCVal(game.lid, 7, 0)))
        goto L_6aac;
    else
        goto L_6a23;
...
L_6a2c:
    scratch_bp_m86 = ((vlprgScoreX[iScoreMax].wWord | 0x1000) & 0x3fc0);
    vlprgScoreX[iScoreMax].grbitVC = 0x0;
    vlprgScoreX[iScoreMax].wWord = (vlprgScoreX[iScoreMax].wWord | scratch_bp_m86);
    if ((GetVCCheck(game.lid, 7) == 0))
        goto L_6aac;
    else
        goto L_6aa1;
...
L_6b66:
    GetVCVal(game.lid, 4, 0);
    /* untranslated: branch HIWORD(lScoreMax) < hiword((int32_t)((uint32_t)(lScore2nd * sext16to32((callresult(int16_t) + 100))) / 0x64)) ? L_6c31 : L_6ba3 */
...
L_6bb1:
    scratch_bp_m86 = ((vlprgScoreX[iScoreMax].wWord | 0x200) & 0x3fc0);
    vlprgScoreX[iScoreMax].grbitVC = 0x0;
    vlprgScoreX[iScoreMax].wWord = (vlprgScoreX[iScoreMax].wWord | scratch_bp_m86);
    if ((GetVCCheck(game.lid, 4) == 0))
        goto L_6c31;
    else
        goto L_6c26;
...
L_6c31:
    if ((game.turn < GetVCVal(game.lid, 9, 0)))
        goto L_6dc4;
    else
        goto L_6c4b;
...
L_6e37:
    /* untranslated: call _wsprintf(pchT, "backup%d", (words(0x0, game.turn) % vcBackupDirs)) -> callresult(int16_t) */
    goto L_6e7a;

L_6e5a:
    /* untranslated: call _wsprintf(pchT, "backup.%03d", (words(0x0, game.turn) % vcBackupDirs)) -> callresult(int16_t) */

L_6e7a:
    mkdir(szBackup);
    strcat(szBackup, 0x9fc);
    return;
}
...
L_7081:
    lpth->thp.wtMax = LOWORD((int32_t)(((lDecay + 0x9) / 0xa)));
    return 0x0;
}
...
L_747e:
    if (((HIWORD((uint32_t)((dx * dx))) + scratch_bp_m28) < HIWORD(lDecay)))
        goto L_748b;
    else
        goto L_7483;

L_7483:
    if (((LOWORD((uint32_t)((dx * dx))) + scratch_bp_m2a) > LOWORD(lDecay)))
        goto L_73aa;
    else
        goto L_748b;
...
L_74cc:
    pctDecay = (uint32_t)((LOWORD(((LOWORD((t_merge_74cc_0001 * 0x3)) + 0x1) * CPlanetsInCircle(lpth->pt, lpth->thm.cMines))) + 0x2));
...
L_760e:
    /* untranslated: part[0x6:4](lpth) = (*(lpth+0x6) - lDecay) */
...
L_7682:
    /* untranslated: part[0xe:2](lpth) = 0x0 */
...
L_77e4:
    ...
    if ((*(lpth + 0x8) < (HIWORD((uint32_t)((dx * dx))) + scratch_bp_m36)))
        goto L_7a47;
    else
        goto L_784a;
...
L_784f:
    if ((*(lpth + 0x6) < (LOWORD((uint32_t)((dx * dx))) + scratch_bp_m38)))
        goto L_7a47;
    else
        goto L_7858;
...
L_78b3:
    if (((*(lpth + 0x8) - HIWORD(cMineCur)) > (HIWORD(lCur) + 0xffff)))
        goto L_7900;
    else
        goto L_78d7;
...
L_78dc:
    if (((*(lpth + 0x6) - LOWORD(cMineCur)) >= (LOWORD(lCur) + 0xffff)))
        goto L_7900;
    else
        goto L_78e3;

L_78e3:
    LOWORD(cMineCur) = ((*(lpth + 0x6) - LOWORD(lCur)) + 0x1);
    HIWORD(cMineCur) = ((*(lpth + 0x8) - HIWORD(lCur)) + 0x0);

L_7900:
    if ((HIWORD(cMineCur) < *(lpth + 0x8)))
        goto L_7931;
    else
        goto L_7913;
...
L_7a34:
    /* untranslated: part[0xa:2](lpth) = (*(lpth+0xa) | (0x1 << lpfl->iPlayer)) */
...
L_7b95:
    /* untranslated: branch sext8to16(byte ds:[(((0x59a2 + loword((192 * iplr))) + 0x70) + lpth->iplr)]) == 0x1 ? L_7e24 : L_7bc3 */
...
L_7e11:
    /* untranslated: part[0xa:2](lpth) = (*(lpth+0xa) | (0x1 << lppl->iPlayer)) */
...
L_8318:
    LOWORD(rgplr[i].rgResSpent[iTT]) = (LOWORD(rgplr[i].rgResSpent[iTT]) + LOWORD((int32_t)((l15pct / 0x2))));
    HIWORD(rgplr[i].rgResSpent[iTT]) = (HIWORD(rgplr[i].rgResSpent[iTT]) + HIWORD((int32_t)((l15pct / 0x2))));
    goto L_837c;

L_8358:
    LOWORD(rgplr[i].rgResSpent[iTT]) = (LOWORD(rgplr[i].rgResSpent[iTT]) + LOWORD(l15pct));
    HIWORD(rgplr[i].rgResSpent[iTT]) = (HIWORD(rgplr[i].rgResSpent[iTT]) + HIWORD(l15pct));
...
L_886d:
     ...
     * (rgplr[idPlayer].iTechCur & 0xf0)), ((rgplr[idPlayer].iTechCur & 0xf0) | part[0x0:1](iTechNext)))) */
    LOWORD(rgplr[i].rgResSpent[iT]) = 0x0;
    HIWORD(rgplr[i].rgResSpent[iT]) = 0x0;
    iTechCur = iTechNext;
    iTechNext = 7;
    goto L_8944;
...
L_896e:
    LOWORD(rgplr[i].rgResSpent[iTechCur]) = (LOWORD(rgplr[i].rgResSpent[iTechCur]) + LOWORD(lSpent));
    HIWORD(rgplr[i].rgResSpent[iTechCur]) = (HIWORD(rgplr[i].rgResSpent[iTechCur]) + HIWORD(lSpent));
    fUsePool = 0;
    fRedoItAll = 1;
    goto L_89f3;
...
L_89cf:
    LOWORD(rgplr[i].rgResSpent[iT]) = LOWORD(lSpent);
    HIWORD(rgplr[i].rgResSpent[iT]) = HIWORD(lSpent);
...
L_8b20:
    LOWORD(rgplr[i].rgResSpent[iT]) = (LOWORD(rgplr[i].rgResSpent[iT]) + LOWORD(lSpent));
    HIWORD(rgplr[i].rgResSpent[iT]) = (HIWORD(rgplr[i].rgResSpent[iT]) + HIWORD(lSpent));
