...
L_00c5:
    MoveTo(hdc, (pt.x + 0xfed4), (pt.y + 0xfed4));
    LineTo(hdc, (pt.x + 0x12c), (pt.y + 0x12c));
    MoveTo(hdc, (pt.x + 0xfed4), (pt.y + 0x12c));
    LineTo(hdc, (pt.x + 0x12c), (pt.y + 0xfed4));
    if ((i != 0x0))
        goto L_015e;
    else
        goto L_0126;
...
L_0131:
    if ((HIWORD(GetTickCount()) > (HIWORD(tick) + 0x0)))
        goto L_015e;
    else
        goto L_014a;

L_014a:
    /* untranslated: branch hiword(callresult(uint32_t)) < (HIWORD(tick) + 0x0) ? L_0156 : L_014f */

L_014f:
    /* untranslated: branch loword(callresult(uint32_t)) >= part[6:0](game.szName[LOWORD(tick)]) ? L_015e : L_0156 */
...
L_01d5:
    SendMessage(hwndFrame, WM_COMMAND, (iScanNew + 0xf41), 0x0);
...
L_0275:
    ...
    GetClientRect(hwnd, &(rc));
    /* untranslated: branch PtInRect(&rc, words(pt.y, pt.x)) == 0x0 ? L_0e6d : L_02ba */

L_02ba:
    rc.bottom = (rc.bottom - dySBar);
    /* untranslated: branch PtInRect(&rc, words(pt.y, pt.x)) == 0x0 ? L_03c3 : L_02da */
...
L_0312:
    /* untranslated: branch FNearAWayPoint(words(pt.y, pt.x), 0x0) == 0x0 ? L_0338 : L_032c */
...
L_037c:
    if ((IWarpMAFromLppl(&(sel.pl), 0x0) > 0x0))
        goto L_03ab;
    else
        goto L_0397;
...
L_04e7:
    /* untranslated: call FFindNearestObject(words(pt.y, pt.x), t_merge_04e7_0001, &scan) -> callresult(int16_t) */
    if ((gd.fSetMassMode != 0x0))
        goto L_053c;
    else
        goto L_0509;
...
L_0570:
    /* untranslated: part[198:2](sel) = ((part[198:2](sel) & 0xfc00) | ((scan.idpl + 0x1) & 0x3ff)) */
...
L_06b0:
    /* untranslated: call FHandleMeasuringTape(&scan, words(pt.y, pt.x)) -> callresult(int16_t) */
    goto L_0eea;
...
L_0a3a:
    if ((LOWORD(lpth) == LOWORD(rgid[iSel])))
        goto L_0a72;
    else
        goto L_0a56;
...
L_0ab6:
    if ((FLookupPlanet(scan.idpl, &(plT)) == 0x0))
        goto L_0eea;
    else
        goto L_0acd;
...
L_0b07:
    /* untranslated: call FAddWayPoint(words(pt.y, pt.x), &scan) -> callresult(int16_t) */
    goto L_0eea;
...
L_0b3c:
    ...
    /* untranslated: branch FNearAWayPoint(words(pt.y, pt.x), 0x1) == 0x0 ? L_0b82 : L_0b69 */

L_0b69:
    /* untranslated: branch FHandleWayPointDrag(words(pt.y, pt.x)) != 0x0 ? L_0eea : L_0b7c */
...
L_0bba:
    if ((FGetNextObjHere(&(scan), 0x1) == 0x0))
        goto L_0eea;
    else
        goto L_0bcf;
...
L_0cb9:
    t_merge_0cd2_0001 = LOWORD(rglpfl[scan.ifl]);
...
L_0d1d:
    ...
    PostMessage(hwndFrame, WM_COMMAND, (iScanZoom + 0xf41), 0x0);
    goto Default;

L_0d47:
    goto L_0da5;
    /* untranslated: d = (dScanInc neg 0x0) */
    goto L_0dc2;
    d = dScanInc;
    goto L_0dc2;
    /* untranslated: d = (dScanPage neg 0x0) */
    goto L_0dc2;
    d = dScanPage;
    goto L_0dc2;
    if ((msg != WM_VSCROLL))
...
L_0fe1:
    ...
    d = (d * 0x4);
    goto L_107d;
    d = ((uint32_t)((d * 0x8)) / 0x3);
    goto L_107d;
    d = ((uint32_t)((d * 0x4)) / 0x3);
    goto L_107d;
    d = ((uint32_t)((d * 0x4)) / 0x5);
    goto L_107d;
    d = ((uint32_t)((d * 0x2)) / 0x3);
    goto L_107d;
...
L_12ec:
    ...
    yMin = (yMax - dy);
    /* untranslated: xOff = (xLeft neg 0x0) */
    yOff = (dGalInv - yTop);
    i = 0x0;
    id = 0x1;
    goto L_13b1;
...
L_13bb:
    /* untranslated: branch ((part[123:2](rgshdef[i]) >> 0x9) & 0x1) == 0x0 ? L_139f : L_13da */
...
L_1b86:
    dThingRange = (((LOWORD(lpth->thp) >> 0xa) & 0xf) + 0x4);
...
L_1cb5:
    t_merge_1cd4_0001 = LOWORD(rglpfl[sel.scan.ifl]);
    goto L_1cd4;

L_1cd1:
    t_merge_1cd4_0001 = 0xffff;
...
L_1d62:
    if ((HIWORD(CShipsScanVis(lpfl)) > 0x0))
        goto L_1da8;
    else
        goto L_1d7a;

L_1d7a:
    /* untranslated: branch hiword(callresult(int32_t)) < 0x0 ? L_1d87 : L_1d7f */

L_1d7f:
    /* untranslated: branch loword(callresult(int32_t)) > 0x0 ? L_1da8 : L_1d87 */
...
L_1e49:
    ...
    BitBlt(hdc, (pt.x + 0xfffb), (pt.y + 0xfffb), 0xb, 0xb, hdcMem, 0xb, 0x50, SRCAND);
    SelectObject(hdcMem, hbmpScanShip);
    goto L_1d0d;

L_1e98:
    GetScanFleetOrientation(lpfl, &(ptO), &(ptD));
    BitBlt(hdc, (pt.x - ((uint32_t)(ptD.x) / 0x2)), (pt.y - ((uint32_t)(ptD.y) / 0x2)), ptD.x, ptD.y, hdcMem, ptO.x, ptO.y, SRCAND);
...
L_1f95:
    ...
    IntersectClipRect(hdc, rcClip.left, rcClip.top, rcClip.right, rcClip.bottom);
    hbrSav = SelectObject(hdc, LOWORD(rghbrPat));
...
L_20b9:
    /* untranslated: t_merge_20ca_0001 = words(0xc:[(j * 0x4)+0x28], 0xc:[(j * 0x4)+0x26]) */
...
L_2178:
    /* untranslated: branch sext8to16(byte 0x25:[(part[112:0](rgplr[idPlayer]) + lpth->iplr)]) != 0x1 ? L_21b3 : L_21ad */
...
L_21f1:
    /* untranslated: branch sext8to16(byte 0x25:[(part[112:0](rgplr[idPlayer]) + lpth->iplr)]) != 0x0 ? L_223a : L_2226 */
...
L_23b0:
    ...
    /* untranslated: call SetBkColor(hdc, words(0xc:[(j * 0x4)+0x28], 0xc:[(j * 0x4)+0x26])) -> callresult(COLORREF) */
...
L_26d5:
    if ((LOWORD(lpth) >= lpth->thw.idPartner))
        goto L_277e;
    else
        goto L_26e9;
...
L_2702:
    ...
    /* untranslated: branch faroff(callresult(THING *)) != 0x0 ? L_272b : L_2723 */

L_2723:
    /* untranslated: branch farseg(callresult(THING *)) == 0x0 ? L_277e : L_272b */
...
L_2795:
    BitBlt(hdc, (pt.x + 0xfffc), (pt.y + 0xfffc), 0x9, 0x9, hdcMem, 0x9, 0x5c, SRCAND);
    BitBlt(hdc, (pt.x + 0xfffc), (pt.y + 0xfffc), 0x9, 0x9, hdcMem, 0x0, 0x5c, SRCPAINT);
    goto L_2ab4;
...
L_2813:
    ...
    BitBlt(hdc, (pt.x - ((uint32_t)(ptD.x) / 0x2)), (pt.y - ((uint32_t)(ptD.y) / 0x2)), ptD.x, ptD.y, hdcMem, ptO.x, ptO.y, SRCPAINT);
...
L_2916:
    ...
    /* untranslated: dx = part[1:0](mpicolgrbitBU[dRange]) */
    if ((((*(lpth + 0x6) >> 0xa) & 0xf) != 0x0))
        goto L_29c8;
    else
        goto L_293f;
...
L_2b19:
    t_merge_2b38_0001 = LOWORD(rglpfl[sel.scan.ifl]);
    goto L_2b38;

L_2b35:
    t_merge_2b38_0001 = 0xffff;
...
L_2beb:
    /* untranslated: branch hiword(callresult(int32_t)) < 0x0 ? L_2bf8 : L_2bf0 */

L_2bf0:
    /* untranslated: branch loword(callresult(int32_t)) > 0x0 ? L_2c19 : L_2bf8 */
...
L_2ebc:
    BitBlt(hdc, (pt.x + 0xfffb), (pt.y + 0xfffb), 0xb, 0xb, hdcMem, 0x0, 0x45, SRCAND);
    BitBlt(hdc, (pt.x + 0xfffb), (pt.y + 0xfffb), 0xb, 0xb, hdcMem, 0x0, 0x21, SRCPAINT);
    goto L_2f55;

L_2f23:
    BitBlt(hdc, (pt.x + 0xffff), (pt.y + 0xffff), 0x3, 0x3, hdcMem, 0xb, 0xf, SRCCOPY);
...
L_2f6d:
    if ((rgptPlan[i].x < (xMin + 0xffce)))
        goto L_2dda;
    else
        goto L_2f85;

L_2f85:
    if ((rgptPlan[i].x >= (xMax + 0x32)))
        goto L_2dda;
    else
        goto L_2f9c;

L_2f9c:
    if ((rgptPlan[i].y < (yMin + 0xffec)))
        goto L_2dda;
    else
        goto L_2fb8;

L_2fb8:
    if ((rgptPlan[i].y >= (yMax + 0x14)))
        goto L_2dda;
    else
        goto L_2fd3;
...
L_3053:
    CtrTextOut(hdc, pt.x, ((pt.y + 0x5) + j), 0x57a4, 0x0);
    if (((grbitScan & 0x2000) == 0x0))
        goto L_2dda;
    else
        goto L_3081;
...
L_311a:
    ...
    pt.y = sel.pt.y;
    LogicalToScan(&(pt));
    BitBlt(hdc, (pt.x + 0xfffb), ((pt.y + 0xb) + j), 0xb, 0xc, hdcMem, 0x0, 0x50, SRCAND);
    BitBlt(hdc, (pt.x + 0xfffb), ((pt.y + 0xb) + j), 0xb, 0xc, hdcMem, 0x0, 0x39, SRCPAINT);
    goto L_322d;
...
L_31aa:
    ...
    pt.y = sel.scan.pt.y;
    LogicalToScan(&(pt));
    BitBlt(hdc, (pt.x + 0xfffd), ((pt.y + 0x7) + j), 0x7, 0x8, hdcMem, 0x16, 0x50, SRCAND);
    BitBlt(hdc, (pt.x + 0xfffd), ((pt.y + 0x7) + j), 0x7, 0x8, hdcMem, 0x16, 0x31, SRCPAINT);
...
L_34ed:
    dRad = (((uint32_t)(pctDesire) / 0xb) + 0x2);
    goto L_3514;

L_3501:
    /* untranslated: dRad = ((sext16to32((pctDesire neg 0x0)) / 0x5) + 0x2) */
...
L_3609:
    rc.left = (pt.x + 0xffff);
    rc.right = (rc.left + 0x9);
    rc.top = (pt.y + 0xffec);
    rc.bottom = (rc.top + 0x8);
...
L_3666:
    /* untranslated: branch sext8to16(byte 0x25:[(part[112:0](rgplr[idPlayer]) + lppl->iPlayer)]) != 0x1 ? L_369d : L_3693 */
...
L_369d:
    /* untranslated: branch sext8to16(byte 0x25:[(part[112:0](rgplr[idPlayer]) + lppl->iPlayer)]) != 0x0 ? L_36d4 : L_36ca */
...
L_36db:
    ...
    PatBlt(hdc, pt.x, (pt.y + 0xffed), 0x1, 0x15, PATCOPY);
    PatBlt(hdc, pt.x, (pt.y + 0xffed), 0x7, 0x6, PATCOPY);
...
L_37b8:
    xOut = (pt.x - vrgScanPO[iOff][0x0]);
    yOut = (pt.y - vrgScanPO[iOff][0x1]);
    hbrSav = SelectObject(hdc, hbrButtonFace);
    PatBlt(hdc, (xOut + 0xfffe), yOut, vrgScanPO[iOff][0x2], 0x1, PATCOPY);
    PatBlt(hdc, (xOut + 0xfffe), ((yOut - vrgScanPO[iOff][0x2]) + 0x1), 0x1, vrgScanPO[iOff][0x2], PATCOPY);
    j = 0x0;
    goto L_39e3;
...
L_397e:
    ...
    PatBlt(hdc, xOut, (yOut - LOWORD(l)), vrgScanPO[iOff][0x3], LOWORD(l), PATCOPY);

L_39cb:
    xOut = (xOut + vrgScanPO[iOff][0x4]);
    j = (j + 0x1);
...
L_3a79:
    /* untranslated: branch signhiword(0xc:[(dRad * 0x2)]) < HIWORD(lPop) ? L_3a9f : L_3a8e */

L_3a8e:
    /* untranslated: branch signhiword(0xc:[(dRad * 0x2)]) > HIWORD(lPop) ? L_3aae : L_3a93 */

L_3a93:
    /* untranslated: branch 0xc:[(dRad * 0x2)] > LOWORD(lPop) ? L_3aae : L_3a99 */
...
L_3acb:
    /* untranslated: branch sext8to16(byte 0x25:[(part[112:0](rgplr[idPlayer]) + lppl->iPlayer)]) != 0x1 ? L_3b01 : L_3af8 */
...
L_3c06:
    BitBlt(hdc, (pt.x + 0xffff), (pt.y + 0xffff), 0x3, 0x3, hdcMem, 0xb, 0x12, SRCCOPY);
...
L_3c73:
    /* untranslated: branch sext8to16(byte 0x25:[(part[112:0](rgplr[idPlayer]) + lppl->iPlayer)]) != 0x1 ? L_3ca8 : L_3ca0 */
...
L_3cad:
    BitBlt(hdc, (pt.x + 0xfffb), (pt.y + 0xfffb), 0xb, 0xb, hdcMem, 0x0, 0x45, SRCAND);
    BitBlt(hdc, (pt.x + 0xfffb), (pt.y + 0xfffb), 0xb, 0xb, hdcMem, 0x0, yBmp, SRCPAINT);
    if ((fStarbase == 0x0))
        goto L_3db8;
    else
        goto L_3d1a;
...
L_3d30:
    ...
    PatBlt(hdc, (pt.x + 0x4), (pt.y + 0xfffa), 0x5, 0x5, BLACKNESS);
    PatBlt(hdc, (pt.x + 0x5), (pt.y + 0xfffa), 0x3, 0x5, PATCOPY);
    PatBlt(hdc, (pt.x + 0x4), (pt.y + 0xfffb), 0x5, 0x3, PATCOPY);
    SelectObject(hdc, hbrSav);
...
L_3dc2:
    ...
    PatBlt(hdc, (pt.x + 0xfff9), (pt.y + 0xfffa), 0x5, 0x5, BLACKNESS);
    PatBlt(hdc, (pt.x + 0xfffa), (pt.y + 0xfffa), 0x3, 0x5, PATCOPY);
    PatBlt(hdc, (pt.x + 0xfff9), (pt.y + 0xfffb), 0x5, 0x3, PATCOPY);
    SelectObject(hdc, hbrSav);
...
L_3e5a:
    ...
    PatBlt(hdc, (pt.x + 0xfffe), (pt.y + 0xfff7), 0x5, 0x5, BLACKNESS);
    PatBlt(hdc, (pt.x + 0xffff), (pt.y + 0xfff7), 0x3, 0x5, PATCOPY);
    PatBlt(hdc, (pt.x + 0xfffe), (pt.y + 0xfff8), 0x5, 0x3, PATCOPY);
    SelectObject(hdc, hbrSav);
...
L_3f02:
    /* untranslated: branch sext8to16(byte 0x25:[(part[112:0](rgplr[idPlayer]) + lppl->iPlayer)]) != 0x1 ? L_3f37 : L_3f2f */
...
L_3f3c:
    BitBlt(hdc, (pt.x + 0xfffe), (pt.y + 0xfffe), 0x5, 0x5, hdcMem, 0xb, yBmp, SRCCOPY);
    if ((fStarbase == 0x0))
        goto L_3fc9;
    else
        goto L_3f77;
...
L_3f8d:
    ...
    PatBlt(hdc, (pt.x + 0x3), (pt.y + 0xfffc), 0x3, 0x3, PATCOPY);
    SelectObject(hdc, hbrSav);
...
L_3fd3:
    hbrSav = SelectObject(hdc, hbrGreen);
    PatBlt(hdc, (pt.x + 0xfffb), (pt.y + 0xfffc), 0x3, 0x3, BLACKNESS);
    PatBlt(hdc, (pt.x + 0xfffc), (pt.y + 0xfffc), 0x1, 0x3, PATCOPY);
    PatBlt(hdc, (pt.x + 0xfffb), (pt.y + 0xfffd), 0x3, 0x1, PATCOPY);
    SelectObject(hdc, hbrSav);
...
L_406b:
    hbrSav = SelectObject(hdc, hbrPurple);
    PatBlt(hdc, (pt.x + 0xffff), (pt.y + 0xfffa), 0x3, 0x3, BLACKNESS);
    PatBlt(hdc, pt.x, (pt.y + 0xfffa), 0x1, 0x3, PATCOPY);
    PatBlt(hdc, (pt.x + 0xffff), (pt.y + 0xfffb), 0x3, 0x1, PATCOPY);
    SelectObject(hdc, hbrSav);
...
L_414d:
    t_merge_416c_0001 = LOWORD(rglpfl[sel.scan.ifl]);
    goto L_416c;

L_4169:
    t_merge_416c_0001 = 0xffff;
...
L_41ba:
    if ((HIWORD(CShipsScanVis(lpflT)) > 0x0))
        goto L_41fc;
    else
        goto L_41d0;

L_41d0:
    /* untranslated: branch hiword(callresult(int32_t)) < 0x0 ? L_41dd : L_41d5 */

L_41d5:
    /* untranslated: branch loword(callresult(int32_t)) > 0x0 ? L_41fc : L_41dd */
...
L_42e4:
    if (((uint16_t)(rgWhatsHere[idP]) == 0x3))
        goto L_4178;
    else
        goto L_42f9;

L_42f9:
    if (((uint16_t)(rgWhatsHere[idP]) == (yBmp + 0x1)))
        goto L_4178;
    else
        goto L_4313;
...
L_4320:
    ...
    yBmp = ((uint16_t)(rgWhatsHere[idP]) + 0xffff);
    if ((fSelected == 0x0))
        goto L_43b9;
    else
        goto L_434f;
...
L_434f:
    BitBlt(hdc, (pt.x + 0xfff7), (pt.y + 0xfff7), 0x13, 0x13, hdcMem, 0x1d, 0x45, SRCAND);
    BitBlt(hdc, (pt.x + 0xfff7), (pt.y + 0xfff7), 0x13, 0x13, hdcMem, 0x1d, LOWORD((0x13 * yBmp)), SRCPAINT);
    goto L_4420;

L_43b9:
    BitBlt(hdc, (pt.x + 0xfffb), (pt.y + 0xfffb), 0xb, 0xb, hdcMem, 0x10, 0x45, SRCAND);
    BitBlt(hdc, (pt.x + 0xfffb), (pt.y + 0xfffb), 0xb, 0xb, hdcMem, 0x10, LOWORD((0xb * yBmp)), SRCPAINT);
...
L_4486:
    BitBlt(hdc, (pt.x + 0xfffb), (pt.y + 0xfffb), 0xb, 0xb, hdcMem, 0xb, (LOWORD((0xb * yBmp)) + 0x24), SRCPAINT);
    if (((grbitScan & 0x1000) == 0x0))
        goto L_4178;
    else
        goto L_44cc;
...
L_44e3:
    DrawScanFleetCount(lpflT, pt.x, (pt.y + 0xfff9), hdc, hdcMem);
...
L_452a:
    /* untranslated: branch sext8to16(byte 0x25:[(part[112:0](rgplr[idPlayer]) + lpflT->iPlayer)]) != 0x1 ? L_4566 : L_4557 */
...
L_460e:
    DrawScanFleetCount(lpflT, pt.x, ((pt.y - ((uint32_t)(ptD.y) / 0x2)) + 0xfffe), hdc, hdcMem);
...
L_4654:
    /* untranslated: call ExpandRc(prc, (dExpand neg 0x0), (dExpand neg 0x0)) -> callresult(void) */
    prc->bottom = (prc->bottom - 0xe);
...
L_4c31:
    /* untranslated: branch (part[6:2](lpfl->lpplord->rgord[0x0]) & 0xf) == 0x6 ? L_4c89 : L_4c47 */

L_4c47:
    /* untranslated: branch (part[6:2](lpfl->lpplord->rgord[0x0]) & 0xf) == 0x5 ? L_4c89 : L_4c5d */

L_4c5d:
    /* untranslated: branch (part[6:2](lpfl->lpplord->rgord[0x0]) & 0xf) == 0x3 ? L_4c89 : L_4c73 */

L_4c73:
    /* untranslated: branch (part[6:2](lpfl->lpplord->rgord[0x0]) & 0xf) != 0x7 ? L_4c92 : L_4c89 */
...
L_4e9a:
    if ((IntersectRect(&(rc), prc, (pdc + 0xc)) == 0x0))
        goto L_5405;
    else
        goto L_4ebe;
...
L_4fcc:
    /* untranslated: branch (hiword(callresult(uint32_t)) + ss:[bp-0x2a]) > HIWORD(r2) ? L_4fe9 : L_4fd1 */

L_4fd1:
    /* untranslated: branch (loword(callresult(uint32_t)) + ss:[bp-0x2c]) > LOWORD(r2) ? L_4fe9 : L_4fd6 */
...
L_5176:
    /* untranslated: ss:[bp-0x30] = rad */
    /* untranslated: ss:[bp-0x2e] = signhiword(rad) */
    /* untranslated: 10-byte ss:[bp-0x3a] = (double)dword ss:[bp-0x30] */
    sqrt((double)(l));
    /* untranslated: ss:[bp-0x42] = pdc->rgrad[i] */
    /* untranslated: ss:[bp-0x40] = signhiword(pdc->rgrad[i]) */
    __aFfcompp();
    /* untranslated: branch JA ? L_50c2 : L_51d7 */
...
L_5208:
    /* untranslated: ss:[bp-0x30] = pdc->rgrad[i] */
    /* untranslated: ss:[bp-0x2e] = signhiword(pdc->rgrad[i]) */
    /* untranslated: 10-byte ss:[bp-0x3a] = (double)dword ss:[bp-0x30] */
    sqrt((double)(l));
    /* untranslated: ss:[bp-0x42] = rad */
    /* untranslated: ss:[bp-0x40] = signhiword(rad) */
    __aFfcompp();
    /* untranslated: branch JBE ? L_5405 : L_5266 */
...
L_5572:
    dx = (rgptPlan[(LOWORD(lpth->thp) & 0x3ff)].x - ptCur.x);
    dy = (rgptPlan[(LOWORD(lpth->thp) & 0x3ff)].y - ptCur.y);
    LOWORD(lWarp2) = (((LOWORD(lpth->thp) >> 0xa) & 0xf) + 0x4);
    HIWORD(lWarp2) = 0x0;
    goto L_55d1;
...
L_55e8:
    lWarp2 = (uint32_t)((lWarp2 * (uint32_t)((lWarp2 * 0x5))));
    lpfl = 0x0;
...
L_5691:
    dx = (lpfl->dirFltX + 0xff81);
    dy = (lpfl->dirFltY + 0xff81);
    if ((dx != 0x0))
        goto L_56d1;
    else
        goto L_56c4;
...
L_5782:
    ...
    /* untranslated: ss:[bp-0x10c] = dy */
    /* untranslated: ss:[bp-0x10a] = signhiword(dy) */
    /* untranslated: ss:[bp-0x114] = dx */
    /* untranslated: ss:[bp-0x112] = signhiword(dx) */
    /* untranslated: m = ((double)dword ss:[bp-0x10c] / (double)dword ss:[bp-0x114]) */
    /* untranslated: ss:[bp-0x10c] = 0x1 */
    /* untranslated: ss:[bp-0x10a] = 0x0 */
    /* untranslated: call sqrt(((double)lWarp2 / ((m * m) + (double)dword ss:[bp-0x10c]))) -> callresult(double) */
    dx5 = LOWORD(__ftol());
    if ((dx >= 0x0))
        goto L_582b;
    else
...
L_5850:
    LogicalToScan(&(ptCur));
    dx5 = PtToScan(dx5);
    /* untranslated: dy5 = (PtToScan(dy5) neg 0x0) */
...
L_58dd:
    /* untranslated: ss:[bp-0x10c] = (dx neg 0x0) */
    /* untranslated: ss:[bp-0x10a] = signhiword((dx neg 0x0)) */
    /* untranslated: ss:[bp-0x114] = dy */
    /* untranslated: ss:[bp-0x112] = signhiword(dy) */
    /* untranslated: m = ((double)dword ss:[bp-0x10c] / (double)dword ss:[bp-0x114]) */
    /* untranslated: ss:[bp-0x10c] = 0x1 */
    /* untranslated: ss:[bp-0x10a] = 0x0 */
    /* untranslated: call sqrt((24 / ((m * m) + (double)dword ss:[bp-0x10c]))) -> callresult(double) */
...
L_5988:
    /* untranslated: ptTick.x = (ptTick.x neg 0x0) */
...
L_59b7:
    /* untranslated: ss:[bp-0x10c] = (dx neg 0x0) */
    /* untranslated: ss:[bp-0x10a] = signhiword((dx neg 0x0)) */
    /* untranslated: ss:[bp-0x114] = (dy neg 0x0) */
    /* untranslated: ss:[bp-0x112] = signhiword((dy neg 0x0)) */
    /* untranslated: dAngle = (atan2((double)dword ss:[bp-0x114], (double)dword ss:[bp-0x10c]) - 0.7853982) */
    i = 0x0;
    goto L_5ae8;

L_5a1c:
    /* untranslated: ss:[bp-0x10c] = 0x5 */
    /* untranslated: ss:[bp-0x10a] = 0x0 */
    /* untranslated: 10-byte ss:[bp-0x116] = (double)dword ss:[bp-0x10c] */
...
L_5e07:
    memset(rgDup, 0x0, (sel.fl.cord * 0x2));
...
L_5f01:
    /* untranslated: branch ss:[pt2] != lpord2[0x1].pt.x ? L_5f25 : L_5f1c */
...
L_5f48:
    /* untranslated: branch ss:[pt] != lpord2[0x1].pt.x ? L_5ebd : L_5f63 */
...
L_630e:
    if ((IntersectRect(&(rcT), prc, &(rc)) == 0x0))
        goto L_6af9;
    else
        goto L_632d;
...
L_6435:
    ...
    rcT = rc;
    rcT.top = (rcT.top + 0x4);
    rcT.bottom = (rcT.bottom - 0x4);
    rcT.left = (rcT.left + 0x4);
    if ((rc.right < 0x168))
        goto DrawTheName;
    else
        goto L_645f;
...
L_6465:
    ...
    dxHole = (LOWORD(l) + 0x6);
    rcT.right = ((LOWORD(l) + 0x6) + rcT.left);
...
L_64d1:
    c = _wsprintf(szWork, "ID #%d", (id + 0x1));
    SetBkMode(hdc, OPAQUE);
    TextOut(hdc, (rcT.left + 0x3), (rcT.top + 0x2), szWork, c);
...
DrawTheName:
    dxHole = ((rc.right - rcT.left) + 0xfffc);
    rcT.right = (((rc.right - rcT.left) + 0xfffc) + rcT.left);
    DrawLockLight(hdc, &(rcT), fFullRedraw);
    rcClip = rcT;
...
L_67ac:
    t_merge_67c5_0001 = LOWORD(rglpfl[sel.scan.ifl]);
...
L_67f1:
    t_merge_6807_0001 = LOWORD(lpThings[sel.scan.ith]);
...
L_6825:
    CchGetString(idsDeepSpaceWaypoint, 0x57a4);
    goto L_683d;
...
L_6846:
    ExtTextOut(hdc, (rcT.left + 0x3), (rcT.top + 0x2), 0x4, &(rcClip), szWork, lstrlen(szWork), 0x0);
...
L_6a66:
    ExtTextOut(hdc, (rcT.left + 0x3), (rcT.top + 0x2), 0x4, &(rcClip), &(szBuf), strlen(szBuf), 0x0);
...
L_6b2f:
    ...
    SelectObject(hdc, hbrButtonHilite);
    PatBlt(hdc, prc->right, prc->top, 0x1, (dy + 0x1), PATCOPY);
...
L_6c6c:
    t_merge_6c75_0001 = ((dGalInv + 0xfc18) - dx);

L_6c75:
    xMax = ((t_merge_6c75_0001 + 0x3) & 0xfffc);
    if ((0x3e8 <= ((dGalInv + 0xfc18) - dy)))
        goto L_6c97;
    else
        goto L_6c91;
...
L_6c97:
    t_merge_6ca0_0001 = ((dGalInv + 0xfc18) - dy);
...
L_6d4b:
    if ((IsWindowVisible(hwndScanner) == 0x0))
        goto L_6f2a;
    else
        goto L_6d5c;
...
L_703e:
    ...
    pt.y = sel.pt.y;
    LogicalToScan(&(pt));
    SetRect(&(rc), ((pt.x + 0xfff5) - dOff), ((pt.y + 0xfff5) - dOff), ((pt.x + 0xc) + dOff), ((pt.y + 0x17) + dOff));
    DrawScanner(hdc, &(rc));
...
L_70ba:
    ...
    pt.y = sel_scan.pt.y;
    LogicalToScan(&(pt));
    SetRect(&(rc), ((pt.x + 0xfffa) - dOff), ((pt.y + 0xfffa) - dOff), ((pt.x + 0x7) + dOff), ((pt.y + 0xf) + dOff));
    DrawScanner(hdc, &(rc));
...
L_715c:
    ...
    rc.left = (xScanTop + 0xa);
    rc.right = ((xScanTop + cx) + 0xffec);
    rc.bottom = ((dGalInv - yScanTop) + 0xfff6);
    rc.top = ((((dGalInv - yScanTop) + 0xfff6) - cy) + 0x14);
    /* untranslated: branch PtInRect(&rc, words(pt.y, pt.x)) == 0x0 ? L_71e7 : L_71e1 */
...
L_725a:
    /* untranslated: call CtrPointScan(words(ptCtr.y, ptCtr.x), fScroll) -> callresult(void) */
    return 0x0;
}
...
L_7316:
    t_merge_731c_0001 = (dGalInv + 0xfc18);

L_731c:
    y = t_merge_731c_0001;
    if ((x >= ((dGalInv + 0xfc18) - cx)))
        goto L_7336;
    else
        goto L_7330;
...
L_7336:
    t_merge_733f_0001 = ((dGalInv + 0xfc18) - cx);
...
L_7567:
    LOWORD(rgpt) = ptIn.x;
    HIWORD(rgpt) = ptIn.y;
    /* untranslated: part[4:2](rgpt) = pscan->pt.x */
    /* untranslated: part[6:2](rgpt) = pscan->pt.y */
...
L_7737:
    sel.fl.lpplord = LpplReAlloc(sel.fl.lpplord, (sel.fl.cord + 0x3));
...
L_7817:
    id = LOWORD(rglpfl[pscan->ifl]);
    goto L_787d;

L_7839:
    id = LOWORD(lpThings[pscan->ith]);
    goto L_787d;
...
L_7a6e:
    iwp = (lpfl->cord + 0xffff);
    goto L_7ab9;

L_7a7e:
    if ((LOWORD(lpord) != ((LOWORD(lpfl->lpplord) + 0x4) + LOWORD((0x12 * iwp)))))
        goto L_7ab5;
    else
        goto L_7aaa;
...
L_7c4f:
    iWarpOld = iWarp;
    /* untranslated: branch FFindNearestObject(words(lpord->pt.y, lpord->pt.x), 0x81, &scan) == 0x0 ? L_7c8b : L_7c77 */
...
L_7d1e:
    ...
    /* untranslated: branch ss:[bp-0x30] > hiword((int32_t)(LGetFleetStat(lpfl, 0x1) / 0xa)) ? L_7f83 : L_7d67 */

L_7d67:
    /* untranslated: branch ss:[bp-0x30] < hiword(callresult(int32_t)) ? L_7d73 : L_7d6c */

L_7d6c:
    /* untranslated: branch ss:[bp-0x32] >= loword(callresult(int32_t)) ? L_7f83 : L_7d73 */

L_7d73:
    if ((HIWORD(lpfl->rgwtMin[0x4]) < HIWORD((int32_t)(((uint32_t)((LGetFleetStat(lpfl, 0x1) * 0x7)) / 0xa)))))
        goto LOptimizeSpeed;
    else
        goto L_7daf;

L_7daf:
    /* untranslated: branch HIWORD(lpfl->rgwtMin[0x4]) > hiword(callresult(int32_t)) ? L_7dbd : L_7db4 */

L_7db4:
    /* untranslated: branch LOWORD(lpfl->rgwtMin[0x4]) < loword(callresult(int32_t)) ? L_7f83 : L_7dbd */
...
L_7f00:
    if ((HIWORD(lFuel) < HIWORD((int32_t)((lpfl->rgwtMin[0x4] / 0x2)))))
        goto L_7f48;
    else
        goto L_7f20;

L_7f20:
    /* untranslated: branch HIWORD(lFuel) > hiword(callresult(int32_t)) ? L_7f2d : L_7f25 */

L_7f25:
    /* untranslated: branch LOWORD(lFuel) <= loword(callresult(int32_t)) ? L_7f48 : L_7f2d */
...
L_802a:
    /* untranslated: branch FCanFleetUseStargates(lpfl, words(*(lpord-0x10), *(lpord-0x12)), words(lpord->pt.y, lpord->pt.x)) != 0x1 ? L_805a : L_8055 */
...
L_80a2:
    /* untranslated: branch FFindNearestObject(words(pt.y, pt.x), 0x4f, &scan) != 0x0 ? L_80c6 : L_80c0 */
...
L_820b:
    /* untranslated: part[8:2](rgpt) = sel.fl.lpplord->rgord[(sel.iwpAct - 0x1)].pt.x */
    /* untranslated: part[10:2](rgpt) = sel.fl.lpplord->rgord[(sel.iwpAct - 0x1)].pt.y */
    /* untranslated: ptPrev.x = part[8:2](rgpt) */
    /* untranslated: ptPrev.y = part[10:2](rgpt) */
    if ((sel.iwpAct != (sel.fl.cord + 0xffff)))
        goto L_8257;
    else
        goto L_824f;
...
L_8257:
    cpt = 0x4;
    /* untranslated: part[12:2](rgpt) = sel.fl.lpplord->rgord[(sel.iwpAct + 0x1)].pt.x */
    /* untranslated: part[14:2](rgpt) = sel.fl.lpplord->rgord[(sel.iwpAct + 0x1)].pt.y */
    /* untranslated: ptNext.x = part[12:2](rgpt) */
    /* untranslated: ptNext.y = part[14:2](rgpt) */

L_8291:
    LOWORD(rgpt) = sel.fl.lpplord->rgord[sel.iwpAct].pt.x;
    HIWORD(rgpt) = sel.fl.lpplord->rgord[sel.iwpAct].pt.y;
    /* untranslated: part[4:2](rgpt) = LOWORD(rgpt) */
    /* untranslated: part[6:2](rgpt) = HIWORD(rgpt) */
    i = 0x0;
    goto L_82e3;
...
L_83e4:
    /* untranslated: branch FNearAWayPoint(words(ptNew.y, ptNew.x), 0x0) != 0x0 ? L_8559 : L_83fb */
...
L_843b:
    ...
    /* untranslated: call FFindNearestObject(words(ptLogical.y, ptLogical.x), grTypeIn, &scan) -> callresult(int16_t) */
...
L_846e:
    LOWORD(rgpt) = ptLogical.x;
    HIWORD(rgpt) = ptLogical.y;
    sbar.id = 0xffff;
...
L_8498:
    LOWORD(rgpt) = scan.pt.x;
    HIWORD(rgpt) = scan.pt.y;
    if ((scan.grobj != grobjPlanet))
        goto L_84b6;
    else
        goto L_84ad;
...
L_84bf:
    sbar.id = LOWORD(rglpfl[scan.ifl]);
    goto L_8508;
...
L_84e7:
    sbar.id = LOWORD(lpThings[scan.ith]);
    goto L_8508;
...
L_850d:
    sbar.pt.x = LOWORD(rgpt);
    sbar.pt.y = HIWORD(rgpt);
...
L_8568:
    /* untranslated: branch LOWORD(rgpt) != part[4:2](rgpt) ? L_857e : L_8576 */

L_8576:
    /* untranslated: branch HIWORD(rgpt) == part[6:2](rgpt) ? L_8584 : L_857e */
...
L_85ed:
    /* untranslated: branch ss:[scan] != sel.fl.lpplord->rgord[(sel.iwpAct + 0x1)].pt.x ? L_862e : L_861f */

L_861f:
    /* untranslated: branch ss:[scan+0x2] != sel.fl.lpplord->rgord[(sel.iwpAct + 0x1)].pt.y ? L_862e : L_8628 */
...
L_8650:
    if ((AlertSz(PszFormatIds(idsSureWantDeleteCurrentWaypoint, 0x0), 0x2024) != 0x6))
        goto L_867f;
    else
        goto L_8679;
...
L_8693:
    hpenSav = SelectObject(hdc, hpenStarbase);
    /* untranslated: call MoveTo(hdc, part[8:2](rgpt), part[10:2](rgpt)) -> callresult(uint32_t) */
    LineTo(hdc, LOWORD(rgpt), HIWORD(rgpt));
    if ((cpt <= 0x3))
        goto L_86f2;
    else
        goto L_86c7;
...
L_86c7:
    ExcludeClipRect(hdc, 0x0, (rc.bottom - dySBar), rc.right, rc.bottom);
    /* untranslated: call LineTo(hdc, part[12:2](rgpt), part[14:2](rgpt)) -> callresult(int16_t) */
...
L_86fd:
    DrawScanXorLines(hdc, rgpt, cpt);
    /* untranslated: LOWORD(rgpt) = part[4:2](rgpt) */
    /* untranslated: HIWORD(rgpt) = part[6:2](rgpt) */
    if (((grbitScan & 0x80) == 0x0))
        goto L_8793;
    else
        goto L_8729;
...
L_8a9f:
    /* untranslated: part[4:2](rgpt) = ptNew.x */
    /* untranslated: part[6:2](rgpt) = ptNew.y */
    BoundPoints(&(rc), rgpt, cpt);
    hdc = GetDC(hwndScanner);
    DrawScanner(hdc, &(rc));
    ReleaseDC(hwndScanner, hdc);
...
L_8b6f:
    ExcludeClipRect(hdc, (rgpt[i].x + 0xfffb), (rgpt[i].y + 0xfffb), (rgpt[i].x + 0x6), (rgpt[i].y + 0x6));
    i = (i + 0x1);
...
L_8bd0:
    ...
    iRopSav = SetROP2(hdc, 0x7);
    MoveTo(hdc, rgpt[0x2].x, *(rgpt + 0xa));
...
L_8c1d:
    LineTo(hdc, rgpt[0x3].x, *(rgpt + 0xe));
...
L_8c74:
    /* untranslated: call FFindNearestObject(words(sel.fl.lpplord->rgord[iNew].pt.y, sel.fl.lpplord->rgord[iNew].pt.x), grobjOther, &scan) ->
     * callresult(int16_t) */
    scan.iwp = iNew;
    ChangeScanSel(&(scan), 0x1);
    return iNew;
...
L_8cd6:
    /* untranslated: call FFindNearestObject(words(pscan->pt.y, pscan->pt.x), pscan->grobj, pscan) -> callresult(int16_t) */

L_8cef:
    if ((memcmp(pscan, 0x4962, 0x10) == 0x0))
        goto L_9095;
    else
        goto L_8d07;
...
L_8ebb:
    /* untranslated: call FEnsurePointOnScreen(words(pscan->pt.y, pscan->pt.x), 0x1) -> callresult(int16_t) */
...
L_9484:
    if ((strcmpi(PszGetCompressedPlanet(rgidPlan[ipl]), szName) == 0x0))
        goto GoWithPartial;
    else
        goto L_94a6;
...
L_94ac:
    if ((iplPartial != 0xffff))
        goto L_9475;
    else
        goto L_94b5;

L_94b5:
    if ((strnicmp(PszGetCompressedPlanet(rgidPlan[ipl]), szName, strlen(szName)) != 0x0))
        goto L_9475;
    else
        goto L_94e6;
...
L_94fa:
    /* untranslated: call FFindNearestObject(words(rgptPlan[ipl].y, rgptPlan[ipl].x), grobjPlanet, &scan) -> callresult(int16_t) */
    ChangeScanSel(&(scan), 0x1);
...
L_9563:
    ...
    if ((strnicmp(szName, szT, cch) != 0x0))
        goto L_959e;
    else
        goto L_9590;
...
L_95fc:
    ifl = ((uint16_t)(*(pch)) + 0xffd0);
    pch = (pch + 0x1);

L_960c:
    /* untranslated: branch (byte 0x25:[(0x175f + sext8to16(*pch))] & 0x4) == 0x0 ? L_9657 : L_9627 */

L_9627:
    ifl = ((LOWORD((0xa * ifl)) + (uint16_t)(*(pch))) + 0xffd0);
    pch = (pch + 0x1);
    if ((ifl > 0x200))
        goto LNotAFleetId;
    else
...
L_9746:
    if ((strcmpi(PszGetFleetName(LOWORD(lpfl)), szName) == 0x0))
        goto LFoundFleetId;
    else
        goto L_9765;
...
L_97b1:
    /* untranslated: branch ((part[6:2](lpfl->lpplord->rgord[0x1]) >> 0x4) & 0xf) != 0x0 ? L_97dd : L_97cf */
...
L_989f:
    /* untranslated: ss:[bp-0x14] = dx */
    /* untranslated: ss:[bp-0x12] = signhiword(dx) */
    /* untranslated: ss:[bp-0x1c] = dy */
    /* untranslated: ss:[bp-0x1a] = signhiword(dy) */
    /* untranslated: dbl = ((((atan2((double)dword ss:[bp-0x1c], (double)dword ss:[bp-0x14]) + 3.1415927) * 4) / 3.141592654) + 0.5) */
    __ftol();
...
L_9ad0:
    ...
    /* untranslated: branch FFindNearestObject(words(ptLogical.y, ptLogical.x), grTypeIn, &scan) == 0x0 ? L_9afc : L_9af0 */
...
L_9b36:
    if ((abs((ptLogical.x - ptLogLast.x)) >= 0x3))
        goto L_9b67;
    else
        goto L_9b4d;

L_9b4d:
    if ((abs((ptLogical.y - ptLogLast.y)) < 0x3))
        goto L_9a11;
    else
        goto L_9b61;
