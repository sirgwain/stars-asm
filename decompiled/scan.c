...
L_7a7e:
    if ((lpord != &(lpfl->lpplord->rgord[iwp])))
        goto L_7ab5;
    else
        goto L_7ac2;
...
L_7d1e:
    ...
    if (((int32_t)(t_call_7d2b) < (int32_t)((LGetFleetStat(lpfl, 1) / 10))))
        goto L_7d73;
    else
        goto LOptimizeSpeed;
